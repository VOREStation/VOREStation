...
/datum/lore/organization/gov/ares
	...
	ship_names = list(
			"Bulwark of the Free Coomers",
			"Sexually Charged Negotiation",
			"Buck Breaker",
			"Cheeki Breeki",
			"Dawnstar Onstar",
			"Fiery Liquid Tacobell Poops",
			"Fister of Ares",
			"Freedom",
			"Space Toasters",
			...
			"Bull Moose Paul Goose",
			"Look Up John Money's History",
			"The Icepick Nosepickers",
			"Gauntlet",
			"Shitfister",
			"Badder Dragon",
			"Bob Dole's Crunk Juice",
			"Laughing Maniac",
			"Liberty",
			"Bahama Mama",
			"Memory of Fallen",
			...
			"Not Insured",
			"People's Fisting",
			"Addicted To Huffing Taint",
			"Prehensile Tounges",
			"Pride of Liberty",
			"Twelve Spiders Piloting This Tincan",
			"Star of Taint",
			"Torch of Freedom",
			"Torch"
			)
	destination_names = list(
			...
			"yet another settlement needing our help",
...
/datum/lore/organization/gov/elysia
	...
	ship_names = list(
			...
			"Flying Portapotty Filled With Raccoons",
			"Nobody Deserves Shackles",
			"Gamer Girl Bathwater Slave",
	...
	destination_names = list(
			"Cygnus",
			"The Ultra Edge Dome of Brutal Kill Mc'Edge Death to the Extreme",
			"Sanctum",
			"Infernum",
...
/datum/lore/organization/gov/fyrds
	...
	ship_names = list(
			...
			"Alvaro de Bazan",
			"Blas de Lezo",
			"Prince Henry Richard Dick Johnson",
			"Alexander Suvorov",
			"Fyodor Ushakov",
			"Charles XI",
