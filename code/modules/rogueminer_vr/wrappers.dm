/obj/effect/step_trigger/teleporter/roguemine_loop/north/Initialize()
	. = ..()
	teleport_x = x
	teleport_y = 16
	teleport_z = z

/obj/effect/step_trigger/teleporter/roguemine_loop/south/Initialize()
	. = ..()
	teleport_x = x
	teleport_y = world.maxy - 16
	teleport_z = z

/obj/effect/step_trigger/teleporter/roguemine_loop/west/Initialize()
	. = ..()
	teleport_x = world.maxx - 16
	teleport_y = y
	teleport_z = z

/obj/effect/step_trigger/teleporter/roguemine_loop/east/Initialize()
	. = ..()
	teleport_x = 16
	teleport_y = y
	teleport_z = z
...
/obj/effect/step_trigger/teleporter/random/rogue/fourbyfour/Initialize()
	. = ..()
...
/obj/effect/step_trigger/teleporter/random/rogue/fourbyfour/onleft/Initialize()
	. = ..()
...
/obj/effect/step_trigger/teleporter/random/rogue/fourbyfour/onright/Initialize()
	. = ..()
...
/obj/effect/step_trigger/teleporter/random/rogue/fourbyfour/ontop/Initialize()
	. = ..()
	teleport_x = quad_L + margin
	teleport_x_offset = quad_R - margin
	teleport_y = quad_D + margin
...
/obj/effect/step_trigger/teleporter/random/rogue/fourbyfour/onbottom/Initialize()
	. = ..()
	teleport_x = quad_L + margin
	teleport_x_offset = quad_R - margin
