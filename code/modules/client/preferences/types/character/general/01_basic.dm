...
/datum/preference/text/human/real_name
	savefile_key = "real_name"
	savefile_identifier = PREFERENCE_CHARACTER
	priority = PREFERENCE_PRIORITY_NAMES

/datum/preference/text/human/real_name/create_default_value()
	return "Character"

/datum/preference/text/human/real_name/is_valid(value)
	if(!istext(value))
		return FALSE
...
/datum/preference/text/human/real_name/apply_to_human(mob/living/carbon/human/target, value)
	return // Applied in copy_to_mob

/datum/preference/text/human/nickname
	savefile_key = "nickname"
	savefile_identifier = PREFERENCE_CHARACTER
	priority = PREFERENCE_PRIORITY_NAMES

/datum/preference/text/human/nickname/create_default_value()
	return null

/datum/preference/text/human/nickname/is_valid(value)
	if(isnull(value))
		return TRUE
	if(!istext(value))
		return FALSE
...
/datum/preference/text/human/nickname/apply_to_human(mob/living/carbon/human/target, value)
	return // Applied in copy_to_mob
