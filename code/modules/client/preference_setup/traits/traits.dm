...
/datum/category_item/player_setup_item/traits/content()
	...
	for(var/trait_name in trait_datums)
		...
		if(!T.validate(pref.traits, src))
			...
			style_class = "linkOn"
		. += "<tr style='vertical-align:top;'><td width=25%><div align='center'><a style='white-space:normal;' [style_class ? "class='[style_class]' " : ""]href='?src=\ref[src];toggle_trait=[lhtml_encode(T.name)]'>[T.name]</a></div></td>"
