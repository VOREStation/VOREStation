...
/datum/category_item/player_setup_item/general/basic/content()
	...
	. += span_bold("Pronouns:") + " <a href='byond://?src=\ref[src];id_gender=1'><b>[pronoun_set_to_genders[pref.identifying_gender]]</b></a><br>"
...
/datum/category_item/player_setup_item/general/basic/OnTopic(var/href,var/list/href_list, var/mob/user)
	if(href_list["rename"])
		...
		var/new_gender = tgui_input_list(user, "Choose your character's pronouns:", "Character Preference", genders_to_pronoun_set, pronoun_set_to_genders[pref.identifying_gender])
		if(new_gender && CanUseTopic(user))
