...
/datum/category_item/player_setup_item/general/basic/load_character(list/save_data)
	// real_name and nickname are now loaded via TG prefs system
...
/datum/category_item/player_setup_item/general/basic/save_character(list/save_data)
	// real_name and nickname are now saved via TG prefs system
...
/datum/category_item/player_setup_item/general/basic/sanitize_character()
	...
	// Sanitize real_name via TG prefs
	...
	// Sanitize nickname via TG prefs
