		...
		if(prob(5))
			...
			switch(pick(1,2,3,4,5,6,7))
				...
				if(5)
					...
					message = pick("YOUR REMOVEDD HAS BEEN MOVED TO [pick("Salusa","Segunda","Cepheus","Andromeda","Gruis","Corona","Aquila","ARES","Asellus")] DEVELOPMENTARY BANK FOR ONWARD REMITTANCE.",\
