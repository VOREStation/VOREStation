...
/datum/event/ianstorm/announce()
	command_announcement.Announce("It has come to our attention that the station passed through an ion storm.  Please monitor all electronic equipment for malREMOVEDctions.", "Anomaly Alert", 'sound/AI/ian_storm.ogg')
	spawn(7 SECONDS)
