...
/datum/event/money_lotto/announce()
	...
	var/body = "The [GLOB.using_map.starsys_name] Times wishes to congratulate <b>[winner_name]</b> for receiving the [GLOB.using_map.starsys_name] Stellar Slam Lottery, and receiving the out of this world sum of [winner_sum] credits!"
	if(!deposit_success)
