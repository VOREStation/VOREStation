...
/datum/event/prison_break/announce()
	if(areas && areas.len > 0)
		GLOB.command_announcement.Announce("[pick("Gr3y.T1d3 virus","Malignant trojan")] detected in [station_name()] [(eventDept == "Security")? "imprisonment":"containment"] subroutines. Secure any compromised areas immediately. Involvement of [GLOB.using_map.facility_type] AI is recommended.", "[eventDept] Alert")
