...
/datum/event/solar_storm/announce()
	command_announcement.Announce("A solar storm has been detected approaching the station. Please halt all EVA activites immediately and return to the interior of the station.", "Anomaly Alert", new_sound = 'sound/AI/AI_vr/Solarstorm-beginning.ogg')	//VOREStation edit: Event announcements
...
/datum/event/solar_storm/start()
	command_announcement.Announce("The solar storm has reached the station. Please refain from EVA and remain inside the station until it has passed.", "Anomaly Alert", new_sound = 'sound/AI/AI_vr/Solarstorm-middle.ogg')	//VOREStation edit: Event announcements
...
/datum/event/solar_storm/end()
	command_announcement.Announce("The solar storm has passed the station. It is now safe to resume EVA activities. Please report to medbay if you experience any unusual symptoms. ", "Anomaly Alert", new_sound = 'sound/AI/AI_vr/Solarstorm-end.ogg')	//VOREStation edit: Event announcements
	adjust_solar_output()
