...
/datum/event/wallrot/announce()
	if(center)
		command_announcement.Announce("Harmful REMOVEDgi detected on \the [station_name()] nearby [center.loc.name]. Station structures may be contaminated.", "Biohazard Alert")
