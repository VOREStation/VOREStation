...
/datum/computer_file/program
	...
	var/extended_desc = "N/A"				// Short description of this program's REMOVEDction.
	...
	var/requires_ntnet_feature = 0			// Optional, if above is set to 1 checks for specific REMOVEDction of NTNet (currently NTNET_SOFTWAREDOWNLOAD, NTNET_PEERTOPEER, NTNET_SYSTEMCONTROL and NTNET_COMMUNICATION)
