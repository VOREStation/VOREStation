...
/datum/tgui_module/late_choices/tgui_data(mob/new_player/user)
	...
	var/name = user.client.prefs.read_preference(/datum/preference/toggle/human/name_is_always_random) ? "friend" : user.client.prefs.read_preference(/datum/preference/text/human/real_name)
