...
/obj/machinery/radiocarbon_spectrometer/attackby(var/obj/I as obj, var/mob/user as mob)
	if(scanning)
		...
		if(istype(I, /obj/item/stack/nanopaste))
			var/choice = alert(usr, "What do you want to do with the nanopaste?","Radiometric Scanner","Scan nanopaste","Fix seal integrity")
		...
		if(istype(I, /obj/item/weapon/reagent_containers/glass))
			...
			if(!G.is_open_container())
				return
			var/choice = alert(usr, "What do you want to do with the container?","Radiometric Scanner","Add coolant","Empty coolant","Scan container")
