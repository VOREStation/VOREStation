...
/datum/design_techweb/modularcomponent/disk/normal
	...
	materials = list(MAT_STEEL = MATERIAL_COST(1), MAT_GLASS = MATERIAL_COST(0.05))
	build_path = /obj/item/computer_hardware/hard_drive/

/datum/design_techweb/modularcomponent/disk/advanced
	name = "advanced hard drive"
	id = "hdd_advanced"
	materials = list(MAT_STEEL = MATERIAL_COST(2), MAT_GLASS = MATERIAL_COST(0.1))
...
/datum/design_techweb/modularcomponent/disk/super
	...
	materials = list(MAT_STEEL = MATERIAL_COST(4), MAT_GLASS = MATERIAL_COST(0.2))
...
/datum/design_techweb/modularcomponent/disk/cluster
	...
	materials = list(MAT_STEEL = MATERIAL_COST(8), MAT_GLASS = MATERIAL_COST(0.4))
...
/datum/design_techweb/modularcomponent/netcard/basic
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.25), MAT_GLASS = MATERIAL_COST(0.05))
...
/datum/design_techweb/modularcomponent/netcard/advanced
	...
	materials = list(MAT_STEEL = MATERIAL_COST(0.5), MAT_GLASS = MATERIAL_COST(0.1))
...
/datum/design_techweb/modularcomponent/netcard/wired
	...
	materials = list(MAT_STEEL = MATERIAL_COST(2.5), MAT_GLASS = MATERIAL_COST(0.2))
...
/datum/design_techweb/modularcomponent/battery/ultra
	...
	materials = list(MAT_STEEL = MATERIAL_COST(8))
...
/datum/design_techweb/modularcomponent/cpu/photonic
	...
	materials = list(MAT_STEEL = MATERIAL_COST(16), glass = 8000)
...
/datum/design_techweb/modularcomponent/cpu/photonic/small
	...
	materials = list(MAT_STEEL = MATERIAL_COST(8), glass = 4000)
...
/datum/design_techweb/modularcomponent/portabledrive/basic
	...
	materials = list(MAT_GLASS = MATERIAL_COST(4))
...
/datum/design_techweb/modularcomponent/portabledrive/advanced
	...
	// req_tech = list(TECH_DATA = 2)
	materials = list(MAT_GLASS = MATERIAL_COST(8))
...
/datum/design_techweb/modularcomponent/portabledrive/super
	...
	materials = list(MAT_GLASS = MATERIAL_COST(16))
