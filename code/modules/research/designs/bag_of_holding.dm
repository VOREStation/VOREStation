...
/datum/design/item/boh/dufflebag_holding
	...
	desc = "A minaturized prototype of the popular Bag of Holding, the Dufflebag of Holding is, REMOVEDctionally, identical to the bag of holding, but comes in a more stylish and compact form."
