...
/datum/design/item/implant/backup
	...
	materials = list(DEFAULT_WALL_MATERIAL = 2000, "glass" = 2000) //2Metal 2Glass - One Implant
...
/datum/design/item/backup_implanter
	...
	id = "implanter_backup"
	req_tech = list(TECH_MATERIAL = 2, TECH_BIO = 2, TECH_DATA = 4, TECH_ENGINEERING = 2)
	materials = list(DEFAULT_WALL_MATERIAL = 8000, "glass" = 8000) //8Metal 8Glass - Four Implants
