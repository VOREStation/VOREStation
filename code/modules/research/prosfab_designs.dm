...
/datum/design/item/prosfab/cyborg/component/radio_upgraded
	...
	materials = list(MAT_STEEL = 10000, MAT_DIAMOND = 2000, MAT_PLASTEEL = 3000, MAT_GLASS = 6500, MAT_SILVER = 3000, MAT_MOPRPHIUM = 560, MAT_DURASTEEL = 800)
...
/datum/design/item/prosfab/cyborg/component/diagnosis_unit_upgraded
	...
	req_tech = list(TECH_MAGNET = 7, TECH_MATERIAL = 5, TECH_PRECURSOR = 1)
	materials = list(MAT_STEEL = 10000, MAT_DIAMOND = 2000, MAT_URANIUM = 4000, MAT_PLASTEEL = 1000, MAT_GLASS = 400, MAT_SILVER = 1000, MAT_MOPRPHIUM = 420, MAT_DURASTEEL = 600)
...
/datum/design/item/prosfab/cyborg/component/armour_very_heavy
	...
	materials = list(MAT_STEEL = 12000, MAT_MOPRPHIUM = 3000, MAT_DURASTEEL = 5000)
