...
/datum/material/leather/generate_recipes()
	recipes = list(
		new /datum/stack_recipe_list("Clothing", list(
			...
			new /datum/stack_recipe("gloves", /obj/item/clothing/gloves/botanic_leather, 2, time = 5 SECONDS, pass_stack_color = TRUE, recycle_material = "[name]"),
		...
		new /datum/stack_recipe_list("Special", list(
