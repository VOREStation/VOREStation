...
/datum/material/leather/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("pouch, small", /obj/item/weapon/storage/pouch/small, 5, time = 15 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add
		new /datum/stack_recipe("pouch, medium", /obj/item/weapon/storage/pouch/medium, 10, time = 20 SECONDS, pass_stack_color = FALSE, recycle_material = "[name]"), //vorestation Add
