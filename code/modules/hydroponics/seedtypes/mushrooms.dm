...
/datum/seed/mushroom
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,12), REAGENT_ID_FUNGI =  list(1,12))
...
/datum/seed/mushroom/plump
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(2,5), REAGENT_ID_FUNGI = list(2,5))
...
/datum/seed/mushroom/hallucinogenic
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1,25), REAGENT_ID_PSILOCYBIN = list(3,5), REAGENT_ID_FUNGI = list(1,25))
...
/datum/seed/mushroom/poison
	...
	chems = list(REAGENT_ID_NUTRIMENT = list(1), REAGENT_ID_AMATOXIN = list(3,3), REAGENT_ID_PSILOCYBIN = list(1,12), REAGENT_ID_FUNGI = list(1,12))
...
/datum/seed/mushroom/poison/death
	...
	mutants = null
	chems = list(REAGENT_ID_NUTRIMENT = list(1,50), REAGENT_ID_AMATOXIN = list(13,3), REAGENT_ID_PSILOCYBIN = list(1,12), REAGENT_ID_FUNGI = list(1,12))
...
/datum/seed/mushroom/towercap/red
	...
	chems = list(REAGENT_ID_WOODPULP = list(1,10), REAGENT_ID_TANNIN = list(1,10), REAGENT_ID_FUNGI = list(1,10))
	mutants = null
...
/datum/seed/mushroom/glowshroom
	...
	mutants = null
	chems = list(REAGENT_ID_RADIUM = list(1,20), REAGENT_ID_FUNGI = list(1,12))
