...
/obj/item/weapon/deck/cah/black/card_text_list = list(
	...
	"When the United States raced the Soviet Union to the moon, the Mexican government REMOVEDneled millions of pesos into research on _____.",
	"Why am I sticky?",
	...
	"(Pick 2) _____: Hours of REMOVED. Easy to use. Perfect for _____!",
