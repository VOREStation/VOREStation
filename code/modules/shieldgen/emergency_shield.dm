...
/obj/machinery/shieldgen/attack_hand(mob/user as mob)
	...
	if (src.active)
		user.visible_message(span_blue("[bicon(src)] [user] deactivated the shield generator."), \
			span_blue("[bicon(src)] You deactivate the shield generator."), \
			"You hear heavy droning fade out.")
		src.shields_down()
	else
		if(anchored)
			user.visible_message(span_blue("[bicon(src)] [user] activated the shield generator."), \
				span_blue("[bicon(src)] You activate the shield generator."), \
