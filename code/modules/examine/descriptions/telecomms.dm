...
/obj/machinery/exonet_node
	...
	is referred to as a terminal node, servicing Virgo Station.<br>\
	<br>\
	...
	<br>\
	This node is privately owned and maintained by Nanotrasen, and allows the users on Virgo Station to have access to the Exonet."
