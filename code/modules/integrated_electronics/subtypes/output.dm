...
/obj/item/integrated_circuit/output/text_to_speech/advanced
	...
	secret_tech = list(TECH_ENGINEERING = 3, TECH_DATA = 4, TECH_ILLEGAL = 1)
...
/obj/item/integrated_circuit/output/sound/beepsky
	...
	spawn_flags = IC_SPAWN_RESEARCH
	secret_tech = list(TECH_ENGINEERING = 2, TECH_DATA = 2, TECH_ILLEGAL = 1)
...
/obj/item/integrated_circuit/output/sound/medbot
	...
	spawn_flags = IC_SPAWN_RESEARCH
	secret_tech = list(TECH_ENGINEERING = 2, TECH_DATA = 2, TECH_BIO = 1)
