<<<<<<< HEAD:code/modules/integrated_electronics/core/device.dm
...
>>>>>>> 3aca2c3... Yet Another Circuit Update (#5549):code/modules/integrated_electronics/core/assemblies/device.dm
