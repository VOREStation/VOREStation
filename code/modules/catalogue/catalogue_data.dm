...
/datum/category_item/catalogue/proc/display_in_chatlog(mob/user)
	...
	to_chat(user, span("notice", "Contributes <b>[value]</b> points to personal exploration REMOVEDd."))
...
/datum/category_item/catalogue/fauna/zaddat
	...
	host nation to REMOVEDd their search for a new home to replace their \
