...
/datum/surgery_step/brainstem/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	if (!hasorgans(target))
		return 0
...
/datum/surgery_step/brainstem/mend_vessels/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 0

/datum/surgery_step/brainstem/mend_vessels/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_vessels/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_vessels/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/brainstem/drill_vertebrae/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 1

/datum/surgery_step/brainstem/drill_vertebrae/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/drill_vertebrae/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/brainstem/drill_vertebrae/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/brainstem/clean_chips/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 2

/datum/surgery_step/brainstem/clean_chips/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/clean_chips/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/clean_chips/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/brainstem/mend_cord/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 3

/datum/surgery_step/brainstem/mend_cord/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_cord/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_cord/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
...
/datum/surgery_step/brainstem/mend_vertebrae/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 4

/datum/surgery_step/brainstem/mend_vertebrae/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_vertebrae/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/mend_vertebrae/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("<span class='danger'>[user]'s hand slips, tearing at [target]'s spinal cord with \the [tool]!</span>" , \
	"<span class='danger'>Your hand slips, tearing at [target]'s spinal cord with \the [tool]!</span>" )
	affected.createwound(PIERCE, 5)
...
/datum/surgery_step/brainstem/realign_tissue/can_use(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	return ..() && target_zone == BP_HEAD && target.op_stage.brainstem == 5

/datum/surgery_step/brainstem/realign_tissue/begin_step(mob/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/realign_tissue/end_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
...
/datum/surgery_step/brainstem/realign_tissue/fail_step(mob/living/user, mob/living/human/target, target_zone, obj/item/tool)
	var/obj/item/organ/external/affected = target.get_organ(target_zone)
	user.visible_message("<span class='danger'>[user]'s hand slips, gouging [target]'s brainstem with \the [tool]!</span>" , \
	"<span class='danger'>Your hand slips, gouging [target]'s brainstem with \the [tool]!</span>" )
	affected.createwound(CUT, 5)
