...
/obj/item/clothing/under/fluff/siren
	...
	description_fluff = "Unlike other competitor suits, the Ward Takahashi Siren jumpsuit features a whole host of extra sensors for augmented reality use, and features a non-invasive neural sensor/stimulator for a fully immersive experience. Outside the home, this suit sees usage with mecha and ship pilots."
...
/obj/item/clothing/shoes/boots/fluff/siren
	...
	icon = 'icons/vore/custom_clothes_vr.dmi'
	icon_override = 'icons/vore/custom_clothes_vr.dmi'
	icon_state = "tronsiren_shoes_mob" //For some reason, this is used for item and worn icons both??
	item_state = "tronsiren_shoes_mob" //I don't think it even checks this variable. why.