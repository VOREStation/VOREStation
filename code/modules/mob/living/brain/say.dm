<<<<<<< HEAD:code/modules/mob/living/carbon/brain/say.dm
...
/mob/living/carbon/brain/handle_message_mode(message_mode, message, verb, speaking, used_radios)
	...
	if(message_mode)
		...
		if(R.radio && R.radio.radio_enabled)
			...
			to_chat(src, "<span class='danger'>Your radio is disabled.</span>")
			return 0
>>>>>>> f1e82ef21af... Merge pull request #8561 from Atermonera/remove_carbonmob_dependencies:code/modules/mob/living/brain/say.dm
