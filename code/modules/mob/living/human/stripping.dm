<<<<<<< HEAD:code/modules/mob/living/carbon/human/stripping.dm
...
/mob/living/human/proc/toggle_internals(var/mob/living/user)
	...
	if(internal)
		...
		visible_message("<span class='danger'>\The [user] disables \the [src]'s internals!</span>")
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/stripping.dm
