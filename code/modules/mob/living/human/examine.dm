<<<<<<< HEAD:code/modules/mob/living/carbon/human/examine.dm
	...
	if(istype(M, /mob/living/human))
		...
		switch(hudtype)
			...
			if("medical")
				return R.hudmode == "Medical"
	return 0
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/examine.dm
