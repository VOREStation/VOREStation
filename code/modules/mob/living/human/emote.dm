<<<<<<< HEAD:code/modules/mob/living/carbon/human/emote.dm
...
/mob/living/human/proc/toggle_wing(var/setting,var/message = 0)
	...
	if(new_flapping != flapping)
		...
		update_wing_showing()
	return 1
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/emote.dm
