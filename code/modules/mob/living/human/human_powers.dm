...
/mob/living/human/proc/setmonitor_state()
	...
	if(choice)
		...
		update_icons_body()
<<<<<<< HEAD:code/modules/mob/living/carbon/human/human_powers.dm
=======
...
/mob/living/human/proc/spawn_larvae()
	...
	if(B.chemicals >= 100)
		...
		return
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/human_powers.dm
