...
<<<<<<< HEAD:code/modules/mob/living/carbon/human/human_helpers.dm
...
/mob/living/human/get_ear_protection()
	if (get_sound_volume_multiplier() <= 0.2)
		...
		return 0
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/human_helpers.dm
