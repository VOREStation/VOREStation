<<<<<<< HEAD:code/modules/mob/living/carbon/human/appearance.dm
...
/mob/living/human/proc/force_update_limbs()
	for(var/obj/item/organ/external/O in organs)
		O.sync_colour_to_human(src)
	update_icons_body(FALSE)
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/appearance.dm
