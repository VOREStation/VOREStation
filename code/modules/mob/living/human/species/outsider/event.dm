...
<<<<<<< HEAD:code/modules/mob/living/carbon/human/species/outsider/event.dm
...
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/species/outsider/event.dm
