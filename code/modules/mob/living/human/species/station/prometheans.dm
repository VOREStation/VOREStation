...
<<<<<<< HEAD:code/modules/mob/living/carbon/human/species/station/prometheans.dm
...
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/species/station/prometheans.dm
	if(H.backbag == 1)
