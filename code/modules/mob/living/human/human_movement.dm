<<<<<<< HEAD:code/modules/mob/living/carbon/human/human_movement.dm
...
/mob/living/human/proc/slide_for(var/slip_dist)
	...
	for(var/i = 1 to slip_dist)
		step(src, dir)
		sleep(1)
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/human_movement.dm
