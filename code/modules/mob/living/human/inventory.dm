<<<<<<< HEAD:code/modules/mob/living/carbon/human/inventory.dm
/*
...
/mob/living/human/get_all_held_items()
	...
	if(r_hand)
		. += r_hand
>>>>>>> 666428014d2... Merge pull request #8546 from Atermonera/surgery_refactor:code/modules/mob/living/human/inventory.dm
