...
/mob/living/silicon/robot/proc/do_transform_animation()
	...
	sleep(2)
	for(var/i in 1 to 6)
		playsound(src, pick('sound/items/drill_use.ogg', 'sound/items/jaws_cut.ogg', 'sound/items/jaws_pry.ogg', 'sound/items/Welder.ogg', 'sound/items/Wirecutter.ogg', 'sound/items/Crowbar.ogg', 'sound/items/Ratchet.ogg', 'sound/items/Deconstruct.ogg'), 80, 1, -1)
		sleep(8)
	if(!prev_lockcharge)
		SetLockdown(0)
	anchored = FALSE
