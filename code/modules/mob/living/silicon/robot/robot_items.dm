...
/obj/item/weapon/form_printer/proc/print_form()
	...
	var/list/other_paper_forms = list("OTHR-9001: Emergency Transmission", "OTHR-9002: Ownership Transfer")
...
/obj/item/weapon/form_printer/proc/select_form(paperid, name)
	...
	switch(paperid)
		...
		if("SUP-2002")
			...
			revision = "Revision: 1.4"
		if("SUP-2003")
			content = "\[hr]\[br]\[center]\[b]Material in stock:\[/b]\[/center]\[br]\[list]\[grid]\[row]\[cell]\[*]Iron:\[cell]\[field]\[br]\[row]\[cell]\[*]Steel:\[cell]\[field]\[br]\[row]\[cell]\[*]Plasteel:\[cell]\[field]\[br]\[row]\[cell]\[*]Durasteel\[cell]\[field]\[br]\[row]\[cell]\[*]Glass:\[cell]\[field]\[br]\[row]\[cell]\[*]Sandstone:\[cell]\[field]\[br]\[row]\[cell]\[*]Uranium:\[cell]\[field]\[br]\[row]\[cell]\[*]Phoron Crystals:\[cell]\[field]\[br]\[row]\[cell]\[*]Gold Bars:\[cell]\[field]\[br]\[row]\[cell]\[*]Silver Ingots:\[cell]\[field]\[br]\[row]\[cell]\[*]Diamonds:\[cell]\[field]\[br]\[row]\[cell]\[*]Plastic:\[cell]\[field]\[br]\[row]\[cell]\[*]Graphite:\[cell]\[field]\[br]\[row]\[cell]\[*]Platinum:\[cell]\[field]\[br]\[row]\[cell]\[*]Osmium:\[cell]\[field]\[br]\[row]\[cell]\[*]Tritium:\[cell]\[field]\[br]\[row]\[cell]\[*]Mhydrogen:\[cell]\[field]\[br]\[row]\[cell]\[*]Verdantium:\[cell]\[field]\[br]\[row]\[cell]\[*]Marble:\[cell]\[field]\[br]\[row]\[cell]\[*]Lead:\[cell]\[field]\[br]\[row]\[cell]\[*]Titanium:\[cell]\[field]\[/grid]\[br]\[/list]\[br]\[small]Leave blank or write 0 if none\[/small]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Supply personnel signature:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.1"
		//Science forms, SCI-3
		if("SCI-3003")
			content = "\[grid]\[row]\[cell]\[row]\[cell]\[b]Roboticist:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Assistant:\[/b] \[cell]\[field]\[/grid]\[br]\[small]Leave blank if none\[/small]\[hr]\[br]\[grid]\[row]\[cell]\[row]\[cell]\[b]Cyborg / Robot:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Module:\[/b] \[cell]\[field]\[/grid]\[br]\[hr]\[br]The following form documents the full inspection of \[\[field]] as performed by \[u]\[sign]\[/u] in the Robotics Labratory aboard the \[station] on \[u]\[date]\[/u].\[br]\[br]\[table]\[row]\[cell]\[b]General \[/b]\[cell]\[center]Status\[/center]\[cell]Comment\[br]\[row]\[cell]\[b]- Laws \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]Component external \[/b]\[cell]\[cell]\[br]\[row]\[cell]\[b]- Robot Endoskeleton \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Left Arm \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Right Arm \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Left Leg \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Right Leg \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Torso \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Head  \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]Component internal \[/b]\[cell]\[cell]\[br]\[row]\[cell]\[b]- Wiring \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Actuator \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Radio \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Power Cell \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Self-Diagnosis Unit \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Camera \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Binary Communication Device \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Armour Plating \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[/table]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Scientist signature:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.1"
		if("SCI-3004")
			content = "\[grid]\[row]\[cell]\[row]\[cell]\[b]Roboticist:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Assistant:\[/b] \[cell]\[field]\[/grid]\[br]\[small]Leave blank if none\[/small]\[hr]\[br]\[grid]\[row]\[cell]\[row]\[cell]\[b]Cyborg / Robot:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Module:\[/b] \[cell]\[field]\[/grid]\[br]\[hr]\[br]The following form documents the installed upgrades into \[\[field]] as performed by \[u]\[sign]\[/u] in the Robotics Labratory aboard the \[station] on \[u]\[date]\[/u].\[br]\[br]\[table]\[row]\[cell]\[b]Lawset\[/b]\[cell]\[center]Status\[/center]\[cell]Comment\[br]\[row]\[cell]\[b]- \[field]\[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]General \[/b]\[cell]\[center]Status\[/center]\[cell]Comment\[br]\[row]\[cell]\[b]- Rename Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Reset Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Emergency Resttart Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- VTEC Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Advanced Health Analyzer Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Robohound Capacity Expansion Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Size Alteration Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Size Gun Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Scrambled Equipment Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Language Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]Security \[/b]\[cell]\[cell]\[br]\[row]\[cell]\[b]- Rapid Taser Cooling Module \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]Mining \[/b]\[cell]\[cell]\[br]\[row]\[cell]\[b]- Proto-Kinetic Accelerator \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[b]- Diamond Drill \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[b]Science \[/b]\[cell]\[cell]\[br]\[row]\[cell]\[b]- Advanced Rapid Part Exchange Device \[/b]\[cell]\[center]\[field]\[/center]\[cell]\[field]\[/table]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Scientist signature:\[/b]\[/list]\[cell]\[list]\[list]\[list]\[list]\[list]\[b]Research Director signature \[small](In case of Law Change)\[/small]:\[/b]\[/list]\[/list]\[/list]\[/list]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[field]\[/large]\[/list]\[cell]\[list]\[list]\[list]\[list]\[list]- \[large]\[field]\[/large]\[/list]\[/list]\[/list]\[/list]\[/list]\[cell]\[br]\[row]\[cell]\[cell]\[cell]\[br]\[row]\[cell]\[list]\[/list]\[cell]\[list]\[list]\[list]\[list]\[list]\[b]Second Command signature \[small](In case of Law Change)\[/small]:\[/b]\[/list]\[/list]\[/list]\[/list]\[/list]\[cell]\[br]\[row]\[cell]\[list]\[/list]\[cell]\[list]\[list]\[list]\[list]\[list]- \[large]\[field]\[/large]\[/list]\[/list]\[/list]\[/list]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.4"
		if("SCI-3009")
			content = "\[grid]\[row]\[cell]\[row]\[cell]\[b]Scientist:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Assistant:\[/b] \[cell]\[field] \[/grid]\[br]\[small]Leave blank if none\[/small]\[br]\[hr]\[br]The following table contains the Genetic Identifier and purpose of the Xenofloral genes as identified by \[u]\[sign]\[/u] in the Xenobotanical Labratory aboard the \[station] on \[u]\[date]\[/u].\[br]\[br]\[table]\[cell]\[b]Genetic Identifier\[/b]\[cell]Genetic Sequence\[row]\[br]\[cell]\[b]-\[field] \[/b]\[cell]\[small]\[b]Hardiness:\[/b] Endurance. Tolerance to toxins, pests, and/or weeds\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Vigour:\[/b] How long the plant takes to mature and produce fruit. How much fruit it produces. Whether it can spread out of its tray(vine).\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Biochemistry:\[/b] Which reagents the fruit contains; which gases the plant generates.\[/small]\[br]\[row]\[cell]\[b]-\[field] \[/b]\[cell]\[small]\[b]Fruit:\[/b] Whether the fruit is juicy and will splatter when thrown; whether the plant has stinging spines and will inject its reagents into anyone coming in contact with it.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Diet:\[/b] Whether the plant consumes gases in its environment; whether the plant is carnivorous (eats pests) or eats tray weeds; how much water and fertilizer it consumes.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Metabolism:\[/b] Whether the plant requires water or fertilizer. Whether it alters the ambient temperature.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Environment:\[/b] Plant's preferred temperature and light levels, and how much tolerance it has for changes in light level.\[/small]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Atmosphere:\[/b] The plant's tolerance for changes in temperature and pressure away from its preferred levels.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Output:\[/b] Whether the plant produces electrical power or bioluminescent light.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Appearance:\[/b] The "shape" of the plant. Also affects whether it can be harvested only once or multiple times.\[/small]\[br]\[row]\[cell]-\[b]\[field] \[/b]\[cell]\[small]\[b]Pigment:\[/b] The color of the plant and its fruit; the color of any bioluminescence.\[/small]\[br]\[row]\[cell]\[b]-\[field] \[/b]\[cell]\[small]\[b]Special:\[/b] The ability to teleport the thrower or target when thrown.\[/small]\[/table]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Scientist signature:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 0.9"
		//Medical forms, MED-4
		if("MED-4001")
			content = "\[hr]\[br]\[grid]\[row]\[cell]\[b]Deceased Patient's Name:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]Date of Birth:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]Attending Physician:\[/b]\[cell]\[field]\[/grid]\[br]\[hr]\[br]\[grid]\[row]\[cell]\[b]Date of Death:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[b]Time of Death:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[b]Cause of Death:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]DNR/DNC Request Present:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]Further Autopsy Notes:\[/b]\[cell]\[field]\[/grid]\[br]\[hr]\[br]\[i]\[small]I, the undersigned, with my authority as a licensed medical practitioner, declare the aforementioned patient to have irreversibly died at the aforementioned date and time in the aforementioned manner. I affirm that all information in this death certificate is true and correct to the best of my knowledge.\[/i]\[/small]\[br]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Signature of Attending Physician:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.2"
		if("MED-4002")
		...
		if("MED-4007")
			content = "\[grid]\[row]\[cell]\[b]Patient Name:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]Patient Occupation:\[/b]\[cell]\[field]\[br]\[row]\[cell]\[cell]\[br]\[row]\[cell]\[b]Psychiatrist:\[/b]\[cell]\[field]\[/grid]\[br]\[hr]\[br]\[b]\[u]Concerns:\[/u]\[/b]\[br]\[br]\[field]\[br]\[br]\[b]\[u]Evaluation:\[/u]\[/b]\[br]\[br]\[field]\[br]\[br]\[b]\[u]Conclusion:\[/u]\[/b]\[br]\[br]\[field]\[br]\[br]\[hr]\[b]\[u]Comments:\[/u]\[/b]\[br]\[br]\[field]\[br]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Psychiatrist Signature:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.3"
		...
		//Other forms, OTHR-9
		if("OTHR-9001")
			content = "\[grid]\[row]\[cell]\[b]Sender:\[/b] \[cell]\[field]\[br]\[row]\[cell]\[b]Position:\[/b] \[cell]\[field]\[/grid]\[br]\[hr]\[br]\[b]Message:\[/b] \[field]\[br]\[br]\[hr]\[grid]\[row]\[cell]\[list]\[b]Signed:\[/b]\[/list]\[cell]\[br]\[row]\[cell]\[list] - \[large]\[sign]\[/large]\[/list]\[cell]\[/grid]"
			revision = "Revision: 1.0"
		if("OTHR-9032")
...
/obj/item/weapon/form_printer/proc/create_form(paperid, name, content, revision)
	...
	var/footer = "\[br]\[hr]\[br]\[center]\[small]Stamp here.\[/small]\[/center]\[br]\[small]" + revision + "\[/small]"
