...
/hook/startup/proc/Widerobot_Module_init_Stray()
	robot_modules["Stray"] = /obj/item/weapon/robot_module/robot/stray //Add to borg array
	whitelisted_module_types += "Stray" //Add to whitelisted borg list
	return 1
