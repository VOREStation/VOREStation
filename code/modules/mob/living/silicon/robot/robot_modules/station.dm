...
/obj/item/robot_module/robot/medical/crisis/New()
	...
	src.modules += new /obj/item/gripper/medical(src)
	src.modules += new /obj/item/shockpaddles/robot(src)
	src.modules += new /obj/item/inflatable_dispenser/robot(src) //VOREStation Add - This is kinda important for rescuing people without making it worse for everyone
	src.emag = new /obj/item/reagent_containers/spray(src)
	src.emag.reagents.add_reagent("pacid", 250)
	src.emag.name = "Polyacid spray"
...
/obj/item/robot_module/robot/miner/New()
	...
	//src.emag = new /obj/item/pickaxe/plasmacutter/borg(src)
