...
/mob/living/silicon/ai/verb/store_core()
	set name = "Store Core"
	set category = "OOC"
	set desc = "Enter intelligence storage. This is REMOVEDctionally equivalent to cryo or robotic storage, freeing up your job slot."

	if(ticker && ticker.mode && ticker.mode.name == "AI malREMOVEDction")
		to_chat(usr, "<span class='danger'>You cannot use this verb in malREMOVEDction. If you need to leave, please adminhelp.</span>")
		return
