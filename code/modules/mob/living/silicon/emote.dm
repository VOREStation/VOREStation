GLOBAL_LIST_INIT(_silicon_default_emotes, list(
...
/mob/living/silicon/get_available_emotes()
	return GLOB._silicon_default_emotes.Copy()

/mob/living/silicon/pai/get_available_emotes()

	var/list/fulllist = list()
	fulllist |= GLOB._silicon_default_emotes
	fulllist |= GLOB._robot_default_emotes
	fulllist |= GLOB._human_default_emotes
	return fulllist
