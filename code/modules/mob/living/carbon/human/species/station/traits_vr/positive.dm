...
/datum/trait/coldresist
	...
	excludes = list(/datum/trait/coldprone, /datum/traits/cold_discomfort, /datum/traits/hot_discomfort)
...
/datum/trait/hotresist
	...
	excludes = list(/datum/trait/hotprone, /datum/traits/cold_discomfort, /datum/traits/hot_discomfort)
