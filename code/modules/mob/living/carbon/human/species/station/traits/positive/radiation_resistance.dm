...
/datum/trait/radioactive_heal
	...
	excludes = list(/datum/trait/glowing_radiation, /datum/trait/rad_resistance, /datum/trait/rad_resistance_extreme, /datum/trait/rad_immune, /datum/trait/rad_weakness)
