/datum/trait/emp_resist
	...
	excludes = list(/datum/trait/faultwires, /datum/trait/poorconstruction, /datum/trait/emp_resist_major)
...
/datum/trait/emp_resist_major
	...
	excludes = list(/datum/trait/faultwires, /datum/trait/poorconstruction, /datum/trait/emp_resist)
	category = TRAIT_TYPE_POSITIVE
