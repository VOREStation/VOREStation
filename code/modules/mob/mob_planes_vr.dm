/datum/plane_holder/New(mob/this_guy)
	...
	plane_masters[VIS_AUGMENTED]		= new /obj/screen/plane_master/augmented(M = my_mob)				//Augmented reality //ChompEDIT - qdel refs - args
	..()
...
/obj/screen/plane_master/augmented/New(null, var/mob/M) //ChompEDIT - qdel refs - args were causing this to spawn in inv instead of nullspace
	..()
	my_mob = M
