...
/datum/camerachunk/proc/add(mob/observer/eye/eye)
...
/datum/camerachunk/proc/remove(mob/observer/eye/eye)
	eye.visibleChunks -= src
	seenby -= eye
...
/datum/camerachunk/proc/update_with_turfs(list/updated_visible_turfs)
	...
	for(var/mob/observer/eye/client_eye as anything in seenby)
