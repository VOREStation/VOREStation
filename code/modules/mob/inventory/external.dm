...
/mob/living/carbon/human/get_equipped_item(slot)
	switch(slot)
		...
		if(slot_gloves)         return inventory.get_item_in_slot(slot_gloves_str)
		if(slot_gloves_str)     return inventory.get_item_in_slot(slot_gloves_str)
