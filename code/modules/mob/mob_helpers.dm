...
/proc/censor_swears(t)
	...
	return replacetext(t, regex("fuck|shit|damn|piss|whore|cunt|bitch|bastard|dick|cock|slut|dong|pussy|twat|snatch|schlong|damn|dammit|damnit|ass|tit|douch|prick|hell|crap", "gmi"), pick("BEEP","BLEEP","BOINK","BEEEEEP"))
