...
/datum/sprite_accessory/ears/elfs1
	...
	do_colouration = 1
	color_blend_mode = ICON_MULTIPLY
	//species_allowed = list(SPECIES_HUMAN, SPECIES_HUMAN_VATBORN, SPECIES_EVENT1, SPECIES_EVENT2, SPECIES_EVENT3)			//Fuck you Polaris, no adding whitelists on our shit
