...
/datum/maint_recycler_vendor_entry/bling_screwdriver
	...
	desc = "With a luxurious gold sheen, this screwdriver is sure to make you the envy of all your zinc and copper hating friends!"
...
/datum/maint_recycler_vendor_entry/bling_crowbar
	...
	desc = "rise and shine, mister blingman. not that i wish to imply you have been dripping on the job, no one is more deserving of this high quality brass crowbar than YOU! buy now!"
...
/datum/maint_recycler_vendor_entry/bling_cutters
	...
	desc = "MATERIAL SCIENTISTS HATE HIM!!! This GOLDEN wirecutter has DEFIED science by being HARDER THAN GOLD! they don't want you to know how, and neither do we!"
	object_type_to_spawn = /obj/item/tool/crowbar/brass
...
/datum/maint_recycler_vendor_entry/bling_welder
	...
	desc = "Do you know how shitty of an idea this is? We don't! buy it!"
