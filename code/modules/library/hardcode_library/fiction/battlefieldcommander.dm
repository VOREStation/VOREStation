...
/obj/item/weapon/book/bundle/custom_library/fiction/chroniclesofmargatavol1
	...
	pages = list({"<html>
				...
				{"<html>
					...
					<div>"We took that part out in post. It was a really long and not very REMOVEDny bit that didn't get much of a reaction out of anyone the first time this story was read out loud. It's a little trick the boys back home call 'the Director's Cut.'"</div>
