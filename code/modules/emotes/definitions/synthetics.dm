...
/decl/emote/audible/synth/security/mob_can_use(var/mob/living/silicon/robot/user)
	return ..() && (istype(user) && (istype(user.module, /obj/item/robot_module/robot/security) || istype(user.module, /obj/item/robot_module/robot/knine))) //VOREStation Add - knine module
