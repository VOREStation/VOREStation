		...
		if("weapons")
			...
			if(prob(50))
				var/new_gun = pick( // Copied from Random.dm
					...
					prob(90);/obj/item/weapon/gun/launcher/crossbow,\
					prob(90);/obj/item/weapon/gun/projectile/shotgun/doublebarrel/pellet,\
					prob(90);/obj/item/weapon/material/knife,\
					prob(90);/obj/item/weapon/material/knife/tacknife/combatknife,\
					prob(90);/obj/item/weapon/material/butterfly/switchblade,\
					prob(90);/obj/item/weapon/gun/projectile/luger,\
					prob(90);/obj/item/weapon/gun/projectile/luger/brown,\
				/*	prob(90);/obj/item/weapon/gun/projectile/pipegun,\ */
					prob(90);/obj/item/weapon/gun/projectile/revolver,\
					prob(90);/obj/item/weapon/gun/projectile/revolver/detective,\
					prob(90);/obj/item/weapon/gun/projectile/revolver/mateba,\
				...
				/*	prob(90);/obj/item/weapon/gun/projectile/shotgun/pump/rifle/mosin,\ */
					...
					prob(70);/obj/item/weapon/gun/projectile/automatic/stg,\
					prob(70);/obj/item/weapon/melee/energy/sword,\
				/*	prob(70);/obj/item/weapon/gun/projectile/automatic/m41a,\ */
					prob(60);/obj/item/weapon/gun/energy/captain,\
					prob(60);/obj/item/weapon/gun/energy/sniperrifle,\
					prob(60);/obj/item/weapon/gun/projectile/automatic/p90,\
					prob(60);/obj/item/weapon/gun/projectile/automatic/as24,\
					prob(60);/obj/item/weapon/gun/projectile/automatic/sts35,\
					prob(60);/obj/item/weapon/gun/projectile/automatic/z8,\
					prob(60);/obj/item/weapon/gun/energy/gun/burst,\
					prob(60);/obj/item/weapon/gun/projectile/shotgun/pump/USDF,\
					prob(60);/obj/item/weapon/gun/projectile/deagle,\
					prob(60);/obj/item/weapon/gun/launcher/grenade,\
				/*	prob(50);/obj/item/weapon/gun/projectile/SVD,\*/
					prob(50);/obj/item/weapon/gun/projectile/automatic/l6_saw,\
					prob(50);/obj/item/weapon/gun/energy/lasercannon,\
					prob(50);/obj/item/weapon/gun/projectile/automatic/bullpup,\
					prob(40);/obj/item/weapon/gun/energy/pulse_rifle,\
				/*	prob(30);/obj/item/weapon/gun/projectile/automatic/battlerifle,\ */
					prob(20);/obj/item/weapon/gun/projectile/deagle/camo,\
					prob(20);/obj/item/weapon/gun/energy/gun/nuclear,\
					prob(10);/obj/item/weapon/gun/projectile/deagle/gold,\
			...
			if(prob(50))
				var/new_ammo = pick( // Copied from Random.dm
					...
					prob(80);/obj/item/ammo_magazine/clip/c545,\
					prob(80);/obj/item/ammo_magazine/clip/c45,\
					prob(80);/obj/item/ammo_magazine/clip/c9mm,\
					prob(80);/obj/item/ammo_magazine/m45uzi,\
					prob(80);/obj/item/ammo_magazine/m545/ext,\
					prob(80);/obj/item/ammo_magazine/m9mm,\
					prob(80);/obj/item/ammo_magazine/m9mml,\
					prob(80);/obj/item/ammo_magazine/m9mmt,\
					prob(80);/obj/item/ammo_magazine/m9mmt/rubber,\
					prob(80);/obj/item/ammo_magazine/m10mm,\
					prob(80);/obj/item/ammo_magazine/m9mmp90,\
				/*	prob(80);/obj/item/ammo_magazine/m14,\
					prob(80);/obj/item/ammo_magazine/m14/large,\*/
					prob(80);/obj/item/ammo_magazine/m545/ext,
					prob(80);/obj/item/ammo_magazine/m762,\
					prob(80);/obj/item/ammo_magazine/m545/ext,\
					...
					prob(40);/obj/item/ammo_magazine/m545,\
					prob(20);/obj/item/weapon/storage/box/frags,\
				/*	prob(20);/obj/item/ammo_magazine/m95,\ */
					...
					prob(20);/obj/item/weapon/storage/box/practiceshells,\
					prob(20);/obj/item/weapon/storage/box/stunshells,\
					prob(20);/obj/item/weapon/storage/box/blanks,\
