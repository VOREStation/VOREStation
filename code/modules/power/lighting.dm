...
/obj/item/light/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I,/obj/item/multitool))
		...
		switch(modification_decision)
			...
			if("Normal Color")
				var/new_color = input(user, "Choose a color to set the light to!", "", brightness_color) as color|null
				if(new_color)
			...
			if("Nightshift Color")
				var/new_color = input(user, "Choose a color to set the light to!", "", nightshift_color) as color|null
				if(new_color)
