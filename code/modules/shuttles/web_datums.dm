...
/datum/shuttle_destination/proc/announce_departure()
	...
	if(!radio_announce)
		GLOB.command_announcement.Announce(get_departure_message(),(announcer ? announcer : "[GLOB.using_map.boss_name]"))
	else
...
/datum/shuttle_destination/proc/announce_arrival()
	...
	if(!radio_announce)
		GLOB.command_announcement.Announce(get_arrival_message(),(announcer ? announcer : "[GLOB.using_map.boss_name]"))
	else
