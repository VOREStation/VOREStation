...
/obj/item/organ/proc/rejuvenate(var/ignore_prosthetic_prefs)
	...
	if(owner)
		handle_organ_mod_special()
	if(!ignore_prosthetic_prefs && owner && owner.client && owner.client.prefs && owner.client.prefs.read_preference(/datum/preference/text/human/real_name) == owner.real_name)
