...
/obj/structure/closet/crate/secure/loot/proc/generate_loot()
	...
	while(lootvalue <= 10) //if the initial generation gives you less than 10 points of stuff, add more stuff
		...
		choice = pickweight(list(
			...
			list(/obj/item/weapon/coin/silver, 2) = 2,
			list(/obj/item/weapon/coin/iron, 2) = 2,
			list(/obj/item/weapon/coin/gold, 2) = 2,
			list(/obj/item/weapon/coin/diamond, 2) = 2,
			list(/obj/item/weapon/coin/phoron, 2) = 2,
			list(/obj/item/weapon/coin/uranium, 2) = 2,
			list(/obj/item/weapon/coin/platinum, 2) = 2,
