...
/obj/item/weapon/gun/energy/gun
	name = "energy gun"
	desc = "Another bestseller of Lawson Arms, the LAEP90 Perun is a versatile energy based carbine, capable of switching between low and high capacity projectile settings. In other words: Stun or Kill."
...
/obj/item/weapon/gun/energy/gun/rifle
	...
	firemodes = list(
		list(mode_name="stun", projectile_type=/obj/item/projectile/beam/stun/med, modifystate="riflestun", wielded_item_state="riflestun-wielded", charge_cost = 120),
		list(mode_name="lethal", projectile_type=/obj/item/projectile/beam, modifystate="riflekill", wielded_item_state="riflekill-wielded", charge_cost = 240),
		)
