...
/obj/item/weapon/gun/energy/monorifle
	...
	description_fluff = "Modeled after ancient hunting rifles designs, this rifle was dubbed the 'Rainy Day Special' by some, due to its use as the choice \"fight-stopper\" of barkeeps. One shot is all it takes... so they say."
	icon_state = "mono"
	item_state = "shotgun"
...
/obj/item/weapon/gun/energy/monorifle/combat
	...
	description_fluff = "A modern design of a classic rifle produced by a small arms company operating out of Saint Columbia. It was based on the antique mono-rifle design that was dubbed the 'Rainy Day Special' by many of its users."
	icon_state = "cmono"
	item_state = "cshotgun"
	charge_cost = 1200
	force = 12
...
/obj/item/weapon/gun/energy/gun/eluger
	name = "\improper MX-20-T \"Ratte\""
	desc = "The finest sidearm produced by RauMauser. Although its internal battery cannot be removed, its ergonomic design makes it easy to shoot, \
	allowing for rapid follow-up shots. It also has the ability to toggle between stun and kill. This particular weapon was based on the \
	Hephaestus Industries own H-H T15b \"Mäuse\" because of its ergonomic design."
	icon_state = "ep08kill"
	item_state = "gun"
	...
	firemodes = list(
	list(mode_name="stun", charge_cost=120, projectile_type=/obj/item/projectile/beam/stun, modifystate="ep08stun", fire_sound='sound/weapons/Taser.ogg'),
	list(mode_name="lethal", charge_cost=240, projectile_type=/obj/item/projectile/beam/eluger, modifystate="ep08kill", fire_sound='sound/weapons/eluger.ogg'),
	)
