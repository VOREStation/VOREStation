...
/obj/item/weapon/gun/energy/plasmastun
	...
	desc = "The RayZar MA21 \"Selkie\" is a weapon that uses a proprietary energy injection system to excite \
	a energy current and turn it into plasma. While superheated plasma weapons aren't legal, lower powered \
	versions such as the \"Selkie\" are common across the galaxy. RayZar's system ionizes the local atmosphere, \
	creating a disorienting pulse of supercharged plasma coupled with a deafening shockwave created by the sudden \
	discharge of said plasma."
	description_fluff = "RayZar is Ward-Takahashi’s main consumer weapons brand, known for producing and licensing \
	a wide variety of specialist energy weapons of various types and quality primarily for the civilian market. \
...
/obj/item/weapon/gun/energy/stunrevolver/detective/verb/reskin_gun()
	...
	options["Lawson Arms LTX1020 (Snub)"] = "snubstun2revolver"
