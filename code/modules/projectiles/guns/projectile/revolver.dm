...
/obj/item/weapon/gun/projectile/revolver
	...
	description_fluff = "MarsTech first made their name in the Second Cold War as the 'Lunar Arms Company' \
	providing home-grown arms to the Selene Federation, but after the formation of the SCG rebranded and \
	relocated to Mars where they remain based to this day. The company was acquired by Hephaestus in the \
	mid 23rd century, and its branding used to present an image of historical prestige and Solar unity \
	for their latest product line. MarsTech operates production facilities out of many of the SCG’s larger colonies."
	icon_state = "revolver"
	item_state = "revolver"
	caliber = ".357"
...
/obj/item/weapon/gun/projectile/revolver/mateba
	name = "mateba"
	desc = "This unique looking handgun is named after an Italian company famous for the original manufacture \
	of these revolvers, and pasta kneading machines. Uses .357 rounds." // Yes I'm serious. -Spades
	icon_state = "mateba"
	origin_tech = list(TECH_COMBAT = 2, TECH_MATERIAL = 2)
...
/obj/item/weapon/gun/projectile/revolver/detective
	name = "revolver"
	desc = "A standard MarsTech R1 snubnose revolver, popular among some law enforcement agencies for its \
	simple, long-lasting construction. Uses .38-Special rounds."
	description_fluff = "The leading civilian-sector high-quality small arms brand of Hephaestus Industries, \
	MarsTech has been the provider of choice for law enforcement and security forces for over 300 years."
