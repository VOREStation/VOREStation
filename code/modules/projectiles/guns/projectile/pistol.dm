...
/obj/item/weapon/gun/projectile/aps
	name = "9mm pistol"
	desc = "The Lumoco Arms P6 Whisper. A standard self-defense pistol that takes standard magazines. Uses 9mm rounds."
	icon_state = "aps"
	item_state = null
	w_class = ITEMSIZE_NORMAL
	caliber = "9mm"
...
/obj/item/weapon/gun/projectile/p92x/large
	magazine_type = /obj/item/ammo_magazine/m9mm/large // Spawns with big magazines that are illegal.
...
/obj/item/weapon/gun/projectile/ecureuil
	...
	It's popular among mercs and security forces alike. Uses 10mm rounds."
	icon_state = "ecureuil"
	item_state = "gun"
	caliber = "10mm"
	magazine_type = /obj/item/ammo_magazine/m10mm/pistol
