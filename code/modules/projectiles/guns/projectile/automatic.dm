...
/obj/item/weapon/gun/projectile/automatic/sts35
	...
	desc = "The Jindal Arms M15 is a durable automatic weapon that has become increasingly popular on the frontier worlds. Uses 5.45mm rounds."
	...
	force = 10
	caliber = "5.45mm"
	origin_tech = list(TECH_COMBAT = 5, TECH_MATERIAL = 1, TECH_ILLEGAL = 2)
...
/obj/item/weapon/gun/projectile/automatic/sts35/update_icon(var/ignore_inhands)
	if(istype(ammo_magazine,/obj/item/ammo_magazine/m545/ext))
		icon_state = "M15-30"
	else if(istype(ammo_magazine,/obj/item/ammo_magazine/m545))
		icon_state = "M15-20"
	else if(istype(ammo_magazine,/obj/item/ammo_magazine/m545/small))
		icon_state = "M15-10"
	else
		icon_state = "M15-e"
	update_held_icon()
...
/obj/item/weapon/gun/projectile/automatic/fal
	name = "\improper JA FAL"
	desc = "The Jindal Arms FAL is a remake of the ancient weapon design used by NATO before it was dissolved. It's well known for it's stopping power and ergonomic design. Uses 7.62mm rounds."
	description_fluff = "A subsidiary of Hephaestus Industries, While Jindal’s rugged, affordable weapons intended for the colonial sector are a major export of Tau Ceti, \
	the Jindal Arms company is perhaps best known for its liberal sale of production licenses to just about any fledgling rimworld venture who asks, and has cash to spare. \
	While Jindal’s 'authentic' Binma-built weapons are renowned for their reliability, the same cannot be said for the hundreds of low-grade (but technically legal) \
	copies circulating the squalid habitats and smoke-filled junk ships of the frontier."
	icon_state = "fal"
	item_state = "fnfal"
	wielded_item_state = "fnfal-wielded"
	item_state = null
	w_class = ITEMSIZE_LARGE
	force = 10
	caliber = "7.62mm"
...
/*
 * Assault Rifle (STS-15)
 */
/obj/item/weapon/gun/projectile/automatic/sts15
	name = "assault rifle"
	desc = "The Jindal Arms STS-15 was once mass produced during the Hegemony War. Many of these older yet still reliable rifles can be found scattered across the frontier. Uses 5.45mm rounds."
	description_fluff = "A subsidiary of Hephaestus Industries, While Jindal’s rugged, affordable weapons intended for the colonial sector are a major export of Tau Ceti, \
	the Jindal Arms company is perhaps best known for its liberal sale of production licenses to just about any fledgling rimworld venture who asks, and has cash to spare. \
	While Jindal’s 'authentic' Binma-built weapons are renowned for their reliability, the same cannot be said for the hundreds of low-grade (but technically legal) \
	copies circulating the squalid habitats and smoke-filled junk ships of the frontier."
	icon_state = "M21"
	item_state = "assault"
	wielded_item_state = "assault-wielded"
	item_state = null
	w_class = ITEMSIZE_LARGE
	force = 10
	caliber = "5.45mm"
...
/obj/item/weapon/gun/projectile/automatic/sts15/update_icon(var/ignore_inhands)
	if(istype(ammo_magazine,/obj/item/ammo_magazine/m545/ext))
		icon_state = "M21-30"
	else if(istype(ammo_magazine,/obj/item/ammo_magazine/m545))
		icon_state = "M21-20"
...
/obj/item/weapon/gun/projectile/automatic/akm
	name = "\improper AKM"
	desc = "The Jindal Arms AKM is a modern take on an ancient weapon design. It's know for its rugged, industrious look and its punch. Uses 7.62mm rounds."
	description_fluff = "A subsidiary of Hephaestus Industries, While Jindal’s rugged, affordable weapons intended for the colonial sector are a major export of Tau Ceti, \
	the Jindal Arms company is perhaps best known for its liberal sale of production licenses to just about any fledgling rimworld venture who asks, and has cash to spare. \
	While Jindal’s 'authentic' Binma-built weapons are renowned for their reliability, the same cannot be said for the hundreds of low-grade (but technically legal) \
	copies circulating the squalid habitats and smoke-filled junk ships of the frontier."
...
/obj/item/weapon/gun/projectile/automatic/akm/update_icon(var/ignore_inhands)
	..()
	if(ammo_magazine)
		icon_state = "akm"
	else
...
/obj/item/weapon/gun/projectile/automatic/bullpup
	name = "bullpup rifle"
	desc = "The bullpup configured GP3 is a battle rifle produced by Gurov Projectile Weapons LLC. It is sold almost exclusively to standing armies across the galaxy. Uses 7.62mm rounds."
	icon_state = "bullpup"
	item_state = "assault" //Placeholder (10/10/2021)
	wielded_item_state = "assault-wielded" //Placeholder (10/10/2021)
	w_class = ITEMSIZE_LARGE
	force = 10
	caliber = "7.62mm"
	origin_tech = list(TECH_COMBAT = 6, TECH_MATERIAL = 1, TECH_ILLEGAL = 4)
	slot_flags = SLOT_BACK
	load_method = MAGAZINE
	magazine_type = /obj/item/ammo_magazine/m762bullpup
	allowed_magazines = list(/obj/item/ammo_magazine/m762bullpup)
	projectile_type = /obj/item/projectile/bullet/rifle/a762
