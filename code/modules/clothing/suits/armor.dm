...
/obj/item/clothing/suit/mob_can_equip(var/mob/living/human/H, slot, disable_warning = FALSE)
...
/obj/item/clothing/suit/armor/pcarrier/mob_can_equip(var/mob/living/human/H, slot, disable_warning = FALSE)
	if(..()) //This will only run if no other problems occured when equiping.
		if(H.gloves)
