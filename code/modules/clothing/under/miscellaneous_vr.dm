...
/obj/item/clothing/gloves/bluespace/deluxe/proc/bluespace_size(mob/user) //Taken from HYPER suit
	...
	var/new_size = tgui_input_number(user, "Put the desired size you wish to be while wearing the bracelet ([RESIZE_SMALL*100]-[RESIZE_HUGE*100]%).", "Set Size", H.size_multiplier*100, RESIZE_HUGE*100, RESIZE_SMALL*100)
	if(!new_size)
		return
