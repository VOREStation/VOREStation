...
/obj/machinery/icecream_vat/proc/get_ingredient_list(var/type)
	switch(type)
		if(ICECREAM_CHOCOLATE)
			return list(REAGENT_ID_MILK, "ice", REAGENT_ID_COCO)
		if(ICECREAM_STRAWBERRY)
			return list(REAGENT_ID_MILK, "ice", REAGENT_ID_BERRYJUICE)
		if(ICECREAM_BLUE)
			return list(REAGENT_ID_MILK, "ice", "singulo")
		if(CONE_WAFFLE)
			return list(REAGENT_ID_FLOUR, REAGENT_ID_SUGAR)
		if(CONE_CHOC)
			return list(REAGENT_ID_FLOUR, REAGENT_ID_SUGAR, REAGENT_ID_COCO)
		else
			return list(REAGENT_ID_MILK, "ice")
