...
/obj/item/food/drinks/cans/attack_self(mob/user)
	. = ..(user)
	if(.)
		return TRUE
...
/obj/item/food/drinks/cans/open(mob/user)
	. = ..()
	if(!cant_open && shaken)
...
/obj/item/food/drinks/cans/process()
	if(shaken <= 0)
		return PROCESS_KILL
	shaken--
...
/obj/item/food/drinks/cans/cola
	...
	food_reagents = list(REAGENT_ID_COLA = 30)
...
/obj/item/food/drinks/cans/decaf_cola
	...
	food_reagents = list(REAGENT_ID_DECAFCOLA = 30)
...
/obj/item/food/drinks/cans/waterbottle
	...
	food_reagents = list(REAGENT_ID_WATER = 30)
...
/obj/item/food/drinks/cans/space_mountain_wind
	...
	food_reagents = list(REAGENT_ID_SPACEMOUNTAINWIND = 30)
...
/obj/item/food/drinks/cans/thirteenloko
	...
	food_reagents = list(REAGENT_ID_THIRTEENLOKO = 30)
...
/obj/item/food/drinks/cans/dr_gibb
	...
	food_reagents = list(REAGENT_ID_DRGIBB = 30)
...
/obj/item/food/drinks/cans/dr_gibb_diet
	...
	food_reagents = list(REAGENT_ID_DIETDRGIBB = 30)
...
/obj/item/food/drinks/cans/starkist
	...
	food_reagents = list(REAGENT_ID_BROWNSTAR = 30)
...
/obj/item/food/drinks/cans/starkistdecaf
	...
	food_reagents = list(REAGENT_ID_BROWNSTARDECAF = 30)
...
/obj/item/food/drinks/cans/space_up
	...
	food_reagents = list(REAGENT_ID_SPACEUP = 30)
...
/obj/item/food/drinks/cans/lemon_lime
	...
	food_reagents = list(REAGENT_ID_LEMONLIME = 30)
...
/obj/item/food/drinks/cans/iced_tea
	...
	food_reagents = list(REAGENT_ID_ICETEA = 30)
...
/obj/item/food/drinks/cans/grape_juice
	...
	food_reagents = list(REAGENT_ID_GRAPEJUICE = 30)
...
/obj/item/food/drinks/cans/tonic
	...
	food_reagents = list(REAGENT_ID_TONIC = 30)
...
/obj/item/food/drinks/cans/sodawater
	...
	food_reagents = list(REAGENT_ID_SODAWATER = 30)
...
/obj/item/food/drinks/cans/gingerale
	...
	food_reagents = list(REAGENT_ID_GINGERALE = 30)
...
/obj/item/food/drinks/cans/root_beer
	...
	food_reagents = list(REAGENT_ID_ROOTBEER = 30)

/////////////////////////BODA VENDOR DRINKS/////////////////////////

/obj/item/food/drinks/cans/kvass
	name = "\improper Kvass"
	...
	food_reagents = list(REAGENT_ID_KVASS = 30)

/obj/item/food/drinks/cans/kompot
	...
	food_reagents = list(REAGENT_ID_KOMPOT = 30)

/obj/item/food/drinks/cans/boda
	name = "\improper Boda"
...
/obj/item/food/drinks/cans/bodaplus
	...
	food_reagents = list(REAGENT_ID_SODAWATER = 15)

/obj/item/food/drinks/cans/bodaplus/Initialize(mapload)
	food_reagents[pick(list(
...
/obj/item/food/drinks/cans/redarmy
	...
	food_reagents = list(REAGENT_ID_POTATOJUICE = 15,
						REAGENT_ID_SODAWATER = 15)

/obj/item/food/drinks/cans/arstbru
	...
	food_reagents = list(REAGENT_ID_TURNIPJUICE = 30)

/obj/item/food/drinks/cans/terra_cola
	...
	food_reagents = list(REAGENT_ID_WATER = 15,
						REAGENT_ID_IRON = 15)
...
/obj/item/food/drinks/cans/straw_cola
	...
	food_reagents = list(REAGENT_ID_STRAWSODA = 30)
...
/obj/item/food/drinks/cans/apple_cola
	...
	food_reagents = list(REAGENT_ID_APPLESODA = 30)
...
/obj/item/food/drinks/cans/lemon_cola
	...
	food_reagents = list(REAGENT_ID_LEMONSODA = 30)
...
/obj/item/food/drinks/cans/sarsaparilla
	...
	food_reagents = list(REAGENT_ID_SARSAPARILLA = 30)

/obj/item/food/drinks/cans/grape_cola
	...
	food_reagents = list(REAGENT_ID_GRAPESODA = 30)

/obj/item/food/drinks/cans/orange_cola
	...
	food_reagents = list(REAGENT_ID_ORANGESODA = 30)

/obj/item/food/drinks/cans/baconsoda
	...
	food_reagents = list(REAGENT_ID_PORKSODA = 30)

/obj/item/food/drinks/cans/bepis
	name = "\improper Bepis"
	...
	food_reagents = list(REAGENT_ID_BEPIS = 30)

/obj/item/food/drinks/cans/astrodew
...
/obj/item/food/drinks/cans/icecoffee
	...
	food_reagents = list(REAGENT_ID_ICECOFFEE = 30)

/obj/item/food/drinks/cans/buzz
	...
	food_reagents = list(REAGENT_ID_BUZZFUZZ = 30)

/obj/item/food/drinks/cans/shambler
	...
	food_reagents = list(REAGENT_ID_SHAMBLERS = 30)

/obj/item/food/drinks/cans/cranberry
	...
	food_reagents = list(REAGENT_ID_SPRITEDCRANBERRY = 30)

/////////////////////////CANNED BOOZE DRINKS/////////////////////////

/obj/item/food/drinks/cans/beercan
	...
	food_reagents = list(REAGENT_ID_BEER = 30)

/obj/item/food/drinks/cans/alecan
	...
	food_reagents = list(REAGENT_ID_ALE = 30)
...
/obj/item/food/drinks/cans/nukie_peach
	...
	food_reagents = list(REAGENT_ID_NUKIEPEACH = 60)
...
/obj/item/food/drinks/cans/nukie_pear
	...
	food_reagents = list(REAGENT_ID_NUKIEPEAR = 60)
...
/obj/item/food/drinks/cans/nukie_cherry
	...
	food_reagents = list(REAGENT_ID_NUKIECHERRY = 60)
...
/obj/item/food/drinks/cans/nukie_melon
	...
	food_reagents = list(REAGENT_ID_NUKIEMELON = 60)
...
/obj/item/food/drinks/cans/nukie_banana
	...
	food_reagents = list(REAGENT_ID_NUKIEBANANA = 60)
...
/obj/item/food/drinks/cans/nukie_rose
	...
	food_reagents = list(REAGENT_ID_NUKIEROSE = 60)
...
/obj/item/food/drinks/cans/nukie_lemon
	...
	food_reagents = list(REAGENT_ID_NUKIELEMON = 60)
...
/obj/item/food/drinks/cans/nukie_fruit
	...
	food_reagents = list(REAGENT_ID_NUKIEFRUIT = 60)
...
/obj/item/food/drinks/cans/nukie_special
	...
	food_reagents = list(REAGENT_ID_NUKIESPECIAL = 60)

/////////////////////////MEGA NUKIES/////////////////////////
//Rare loot energy drinks with special properties, for the funnies.

/obj/item/food/drinks/cans/nukie_mega_sight
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGASIGHT = 60)

/obj/item/food/drinks/cans/nukie_mega_heart
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGAHEART = 60)

/obj/item/food/drinks/cans/nukie_mega_sleep
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGASLEEP = 60)

/obj/item/food/drinks/cans/nukie_mega_shock
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGASHOCK = 60)

/obj/item/food/drinks/cans/nukie_mega_fast
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGAFAST = 60)

/obj/item/food/drinks/cans/nukie_mega_high
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGAHIGH = 60)

/obj/item/food/drinks/cans/nukie_mega_shrink
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGASHRINK = 60)

/obj/item/food/drinks/cans/nukie_mega_grow
	...
	food_reagents = list(REAGENT_ID_NUKIEMEGAGROWTH = 60)

////////////////////////Event Only Nukie//////////////////////////////////

/obj/item/food/drinks/cans/nukie_one
	...
	food_reagents = list(REAGENT_ID_NUKIEONE = 60)
