...
/obj/item/food/slice/sushi/filled
	...
	icon_state = "sushi_s"
	bitesize = 5
	whole_path = /obj/item/food/sliceable/sushi

/obj/item/food/slice/sushi/filled/filled
	filled = TRUE
...
/obj/item/food/goulash/Initialize(mapload)
	. = ..()
...
/obj/item/food/donerkebab/Initialize(mapload)
	. = ..()
...
/obj/item/food/roastbeef/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 4) //For meaty things.
	bitesize = 2


/obj/item/food/reishicup
	name = "reishi's cup"
...
/obj/item/food/reishicup/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/wings/update_icon()
	var/i = 0
	for(var/obj/item/food/W in contents)
		i++
...
/obj/item/food/chickenwing/Initialize(mapload)
	. = ..()
...
/obj/item/food/hotandsoursoup/Initialize(mapload)
	. = ..()
	bitesize = 2
...
/obj/item/food/kitsuneudon/Initialize(mapload)
	. = ..()
	bitesize = 2
...
/obj/item/food/mammi/Initialize(mapload)
	. = ..()
	bitesize = 3

/obj/item/food/makaroni
...
/obj/item/food/makaroni/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 1)
	reagents.add_reagent(REAGENT_ID_SHOCKCHEM, 6)
	bitesize = 7
...
/obj/item/food/lobster/Initialize(mapload)
	. = ..()
	bitesize = 0.1

/obj/item/food/lobstercooked
	name = "cooked lobster"
...
/obj/item/food/lobstercooked/Initialize(mapload)
	. = ..()
	bitesize = 5
...
/obj/item/food/cuttlefish/Initialize(mapload)
	. = ..()
	bitesize = 10

/obj/item/food/cuttlefishcooked
...
/obj/item/food/cuttlefishcooked/Initialize(mapload)
	. = ..()
	bitesize = 5
	reagents.add_reagent(REAGENT_ID_PROTEIN, 10)

/obj/item/food/sliceable/monkfish
	...
	slice_path = /obj/item/food/monkfishfillet
	slices_num = 6
	trash = /obj/item/food/sliceable/monkfishremains

/obj/item/food/sliceable/monkfish/Initialize(mapload)
	. = ..()
	bitesize = 2
...
/obj/item/food/monkfishfillet/Initialize(mapload)
	. = ..()
	bitesize = 3
	reagents.add_reagent(REAGENT_ID_PROTEIN, 1)

/obj/item/food/monkfishcooked
...
/obj/item/food/monkfishcooked/Initialize(mapload)
	. = ..()
	bitesize = 4
	reagents.add_reagent(REAGENT_ID_PROTEIN, 5)

/obj/item/food/sliceable/monkfishremains
...
/obj/item/food/sliceable/monkfishremains/Initialize(mapload)
	. = ..()
	bitesize = 0.01 //impossible to eat
	reagents.add_reagent(REAGENT_ID_CARBON, 5)

/obj/item/food/sliceable/sharkchunk
	...
	nutriment_amt = 15
	w_class = ITEMSIZE_LARGE
	slice_path = /obj/item/food/carpmeat/fish/sharkmeat
	slices_num = 5

/obj/item/food/sliceable/sharkchunk/Initialize(mapload)
	. = ..()
	bitesize = 3
	reagents.add_reagent(REAGENT_ID_PROTEIN, 20)
...
/obj/item/food/carpmeat/fish/sharkmeat/Initialize(mapload)
	. = ..()
	bitesize = 3
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)

/obj/item/food/sharkmeatcooked
	name = "shark steak"
...
/obj/item/food/sharkmeatcooked/Initialize(mapload)
	. = ..()
	bitesize = 3
	reagents.add_reagent(REAGENT_ID_PROTEIN, 8)

/obj/item/food/sharkmeatdip
...
/obj/item/food/sharkmeatdip/Initialize(mapload)
	. = ..()
	bitesize = 3
...
/obj/item/food/sharkmeatcubes/Initialize(mapload)
	. = ..()
	bitesize = 10
	reagents.add_reagent(REAGENT_ID_POTATOJUICE, 30) // for people who want to get fat, FAST.

/obj/item/food/monkeycube/sobakacube
	name = "sobaka cube"
	monkey_type = SPECIES_MONKEY_AKULA

/obj/item/food/monkeycube/wrapped/sobakacube
	name = "sobaka cube"
	monkey_type = SPECIES_MONKEY_AKULA

/obj/item/food/monkeycube/sarucube
	name = "saru cube"
	monkey_type = SPECIES_MONKEY_SERGAL

/obj/item/food/monkeycube/wrapped/sarucube
	name = "saru cube"
	monkey_type = SPECIES_MONKEY_SERGAL

/obj/item/food/monkeycube/sparracube
	name = "sparra cube"
	monkey_type = SPECIES_MONKEY_NEVREAN

/obj/item/food/monkeycube/wrapped/sparracube
	name = "sparra cube"
	monkey_type = SPECIES_MONKEY_NEVREAN
...
/obj/item/food/monkeycube/wrapped/wolpincube
	name = "wolpin cube"
	monkey_type = SPECIES_MONKEY_VULPKANIN
...
/obj/item/food/cube
	...
	var/food_type = "/obj/item/food/proteinslab"

/obj/item/food/cube/Initialize(mapload)
	. = ..()

/obj/item/food/cube/proc/Expand()
	src.visible_message(span_infoplain(span_bold("\The [src]") + " expands!"))
	new food_type(get_turf(src))
	qdel(src)

/obj/item/food/cube/on_reagent_change()
	if(reagents.has_reagent(REAGENT_ID_WATER))
		Expand()

/obj/item/food/cube/protein

/obj/item/food/cube/protein/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_MEATCOLONY, 5)

/obj/item/food/proteinslab
	name = "Protein slab"
...
/obj/item/food/proteinslab/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 30)

/obj/item/food/cube/nutriment
	name = "Nutriment cube"
	desc = "A colony of plant cells, Just add water!"
	icon_state = "nutrimentcube"
	food_type = "/obj/item/food/nutrimentslab"

/obj/item/food/cube/nutriment/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PLANTCOLONY, 5)

/obj/item/food/nutrimentslab
	name = "Nutriment slab"
...
/obj/item/storage/box/wings/tray //Might as well re-use this code.
	...
	starts_with = list(
		/obj/item/food/cube/protein = 4,
		/obj/item/food/cube/nutriment = 4
	)
	can_hold = list(/obj/item/food/cube/protein,
					/obj/item/food/cube/nutriment)

/obj/item/food/carpmeat/sif //Making fish meat non-toxic!  As advised by Ascian!
	toxin_type = null
	toxin_amount = null

/obj/item/food/carpmeat/sif/murkfish
	toxin_type = null
...
/obj/item/food/nachos/Initialize(mapload)
	. = ..()
...
/obj/item/food/cheesenachos/Initialize(mapload)
	. = ..()
...
/obj/item/food/milosoup/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_WATER, 5)
...
/obj/item/food/onionsoup/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/wings/bucket
	...
	starts_with = list(
		/obj/item/food/grub = 6
	)
	can_hold = list(/obj/item/food/grub)
...
/obj/item/food/grub/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)
	bitesize = 3

/obj/item/food/grub_pink
...
/obj/item/food/grub_pink/Initialize(mapload)
	. = ..()
	bitesize = 3

/obj/item/food/grub_purple
...
/obj/item/food/grub_purple/Initialize(mapload)
	. = ..()
	bitesize = 3

/obj/item/food/grub_blue
...
/obj/item/food/grub_blue/Initialize(mapload)
	. = ..()
	bitesize = 3

/obj/item/food/scorpion
	name = "scorpion"
...
/obj/item/food/scorpion/Initialize(mapload)
	. = ..()
	bitesize = 1

/obj/item/food/scorpion_cooked
...
/obj/item/food/scorpion_cooked/Initialize(mapload)
	. = ..()
...
/obj/item/food/ant
	...
	slice_path = /obj/item/food/antball
	slices_num = 1

/obj/item/food/ant/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_HONEY, 2)
	reagents.add_reagent(REAGENT_ID_PROTEIN, 3)
	bitesize = 1

/obj/item/food/antball
...
/obj/item/food/antball/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_HONEY, 2)
	bitesize = 1

/obj/item/food/honey_candy
	name = "honey candy"
...
/obj/item/food/honey_candy/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_SUGAR, 2)
	bitesize = 2

/obj/item/food/locust
...
/obj/item/food/locust/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 1)
	bitesize = 2
...
/obj/item/food/locust_cooked/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 3)
	bitesize = 2

/obj/item/food/donkpocket/ascended
	name = "Donk-pocket EX"
...
/obj/item/food/donkpocket/ascended/Initialize(mapload)
	. = ..()
...
/obj/item/food/ratliquid/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 4)

/obj/item/food/ratsteak
...
/obj/item/food/ratsteak/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 3)

/obj/item/food/ratfruitcake
...
/obj/item/food/ratpackramen/Initialize(mapload)
	. = ..()
...
/obj/item/food/bourbon/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/jaffacake //This is kinda like the donut box.
	...
	can_hold = list(/obj/item/food/jaffacake)
	starts_with = list(
		/obj/item/food/jaffacake = 12
	)
	foldable = null

/obj/item/food/winegum
	name = "wine gum"
...
/obj/item/storage/box/winegum //This is kinda like the donut box.
	...
	can_hold = list(/obj/item/food/winegum)
	starts_with = list(
		/obj/item/food/winegum = 3,
		/obj/item/food/winegum/orange = 4,
		/obj/item/food/winegum/black = 3,
		/obj/item/food/winegum/green = 3,
		/obj/item/food/winegum/yellow = 3,
		/obj/item/food/winegum/white = 4
	)
	foldable = null
...
/obj/item/food/packaged/pasty/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)

/obj/item/food/saucer
...
/obj/item/food/saucer/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/saucer //This is kinda like the donut box.
	...
	var/startswith = 20
	max_storage_space = ITEMSIZE_COST_TINY * 20
	can_hold = list(/obj/item/food/saucer)
	starts_with = list(
		/obj/item/food/saucer = 20,
	)
	foldable = null

/obj/item/food/custardcream
	name = "Custard Cream"
...
/obj/item/storage/box/custardcream //This is kinda like the donut box.
	...
	var/startswith = 12
	max_storage_space = ITEMSIZE_COST_SMALL * 12
	can_hold = list(/obj/item/food/custardcream)
	starts_with = list(
		/obj/item/food/custardcream = 12
	)
	foldable = null

/obj/item/food/bourbon
...
/obj/item/storage/box/bourbon //This is kinda like the donut box.
	...
	var/startswith = 12
	max_storage_space = ITEMSIZE_COST_SMALL * 12
	can_hold = list(/obj/item/food/bourbon)
	starts_with = list(
		/obj/item/food/bourbon = 12
	)
	foldable = null
...
/obj/item/food/packaged/sausageroll/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)
...
/obj/item/food/packaged/scotchegg/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)

/obj/item/food/foam_banana
	name = "Foam Banana"
...
/obj/item/storage/box/shrimpsandbananas //This is kinda like the donut box.
	...
	var/startswith = 20
	max_storage_space = ITEMSIZE_COST_TINY * 20
	can_hold = list(/obj/item/food/foam_banana,/obj/item/food/foam_shrimp)
	starts_with = list(
		/obj/item/food/foam_banana = 10,
		/obj/item/food/foam_shrimp = 10
	)
	foldable = null

/obj/item/food/rhubarbcustard
...
/obj/item/food/rhubarbcustard/Initialize(mapload)
	. = ..()
	icon_state = pick(color_options)
...
/obj/item/storage/box/rhubarbcustard //This is kinda like the donut box.
	...
	can_hold = list(/obj/item/food/rhubarbcustard)
	starts_with = list(
		/obj/item/food/rhubarbcustard = 15,
	)
	foldable = null
...
/obj/item/food/packaged/porkpie/Initialize(mapload)
	. = ..()
	reagents.add_reagent(REAGENT_ID_PROTEIN, 2)
...
/obj/item/food/acorn/Initialize(mapload)
	. = ..()
