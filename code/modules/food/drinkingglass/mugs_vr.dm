...
/obj/item/reagent_containers/food/drinks/mug/cap
	name = "captain's mug"
	desc = "An inscription on the side reads \"Best Captain 2299\"... The last time the station had a worthy captain."
	icon_state = "mug_cap"
	preset = TRUE
...
/obj/random/mech_toy/item_to_spawn()
	return pick(typesof(/obj/item/reagent_containers/food/drinks/mug))
