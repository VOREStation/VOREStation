...
/obj/item/weapon/reagent_containers/food/drinks/mug/cap
	name = "site manager's mug"
	desc = "An inscription on the side reads \"Best Manager 2299\"... The last time the station had a worthy site manager."
	icon_state = "mug_cap"
	preset = TRUE

/obj/random/mug
	name = "Random Mug"
	desc = "This is a random mug. Mug a coder if you see this."
	icon = 'icons/obj/mugs_vr.dmi'
	icon_state = "mug_cap"

/obj/random/mug/item_to_spawn()
	return pick(typesof(/obj/item/weapon/reagent_containers/food/drinks/mug))
