/obj/item/food/drinks/glass2/fitnessflask
	name = "fitness shaker"
	base_name = "shaker"
...
/obj/item/food/drinks/glass2/fitnessflask/Initialize(mapload)
	. = ..()
	lid_color = pick("black", "red", "blue")
	update_icon()

/obj/item/food/drinks/glass2/fitnessflask/update_icon()
	..()
	icon_state = "[base_icon]_[lid_color]"
	cut_overlays()

/obj/item/food/drinks/glass2/fitnessflask/proteinshake
	name = "protein shake"
...
/obj/item/food/drinks/glass2/fitnessflask/proteinshake/Initialize(mapload)
	. = ..()
	cut_overlays()
...
/obj/item/food/drinks/glass2/fitnessflask/proteinshake/update_icon()
	return
