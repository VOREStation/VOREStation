...
/obj/machinery/vending/fitness
	...
	contraband = list(/obj/item/reagent_containers/syringe/steroid = 4, /obj/item/reagent_containers/food/drinks/glass2/fitnessflask/proteanshake = 2) // VOREStation Add - Slurpable blobs.
