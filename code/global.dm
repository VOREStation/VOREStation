...
var/secret_force_mode = "secret"   // if this is anything but "secret", the secret rotation will forcibly choose this mode.
...
var/mouse_respawn_time = 2.5 // Amount of time that must pass between a player dying as a mouse and respawning as a mouse. In minutes. Vorestation Edit - Changed to 2.5 minutes, half of 5, in accordance with mouse nerfs and realignment.
