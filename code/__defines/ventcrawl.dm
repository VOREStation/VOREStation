...
#define VENTCRAWL_BASE_WHITELIST /atom/movable/screen, /atom/movable/emissive_blocker, /obj/machinery/camera, /obj/item/radio/headset/mob_headset, /obj/item/radio/borg, /obj/item/rig/protean, /obj/item/implant
//mob/living/simple_mob/borer, //VORESTATION AI TEMPORARY REMOVAL REPLACE BACK IN LIST WHEN RESOLVED

/// Vore unique objects
#define VENTCRAWL_VORE_WHITELIST /obj/belly, /obj/soulgem, /obj/item/holder
