...
/obj/mecha/combat/gorilla/Initialize()
	..()
	var/obj/item/mecha_parts/mecha_equipment/ME = new /obj/item/mecha_parts/mecha_equipment/tesla_energy_relay(src) // This thing basically cannot REMOVEDction without an external power supply.
	ME.attach(src)
