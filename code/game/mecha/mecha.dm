...
/obj/mecha/proc/operation_allowed(mob/living/carbon/human/H)
	for(var/ID in list(H.get_active_hand(), H.inventory.get_item_in_slot(slot_wear_id_str), H.inventory.get_item_in_slot(slot_belt_str)))
...
/obj/mecha/proc/internals_access_allowed(mob/living/carbon/human/H)
	if(istype(H))
		for(var/atom/ID in list(H.get_active_hand(), H.inventory.get_item_in_slot(slot_wear_id_str), H.inventory.get_item_in_slot(slot_belt_str)))
