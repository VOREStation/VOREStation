...
/*
/obj/mecha/micro/range_action(target as obj|mob|turf)
...
/*
/obj/mecha/micro/proc/mega_shake(target)
...
*/
/*
/obj/mecha/micro/hear_talk(mob/M as mob, text)
	..()
	if(am && M==occupant)
		if(findtext(text,""))
			sam()
