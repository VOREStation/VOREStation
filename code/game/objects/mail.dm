/obj/item/mail
	...
	var/list/generic_goodies = list(
		...
		/obj/item/food/drinks/cans/cola = 75,
		/obj/item/food/chips = 75,
		/obj/item/food/drinks/coffee = 75,
		/obj/item/food/drinks/tea = 75,
		/obj/item/food/drinks/glass2/coffeemug/nt = 50,
		/obj/item/spacecash/c100 = 40,
		/obj/item/spacecash/c200 = 25,
		/obj/item/spacecash/c500 = 15,
		/obj/item/spacecash/c1000 = 5,
		/obj/item/food/drinks/bluespace_coffee = 5
	)
	// Overlays (pure fluff)
...
/obj/item/mail/proc/junk_mail()
	...
	var/list/junk_names = list(
		...
		/obj/item/food/donkpocket/berry = "[initial(name)] with NEW BERRY-POCKET.",
		/obj/item/food/donkpocket/dankpocket = "[initial(name)] with NEW DANK-POCKET.",
		/obj/item/food/donkpocket/gondola = "[initial(name)] with NEW GONDOLA-POCKET.",
		/obj/item/food/donkpocket/honk = "[initial(name)] with NEW HONK-POCKET.",
		/obj/item/food/donkpocket/pizza = "[initial(name)] with NEW PIZZA-POCKET.",
		/obj/item/food/donkpocket/spicy = "[initial(name)] with NEW SPICY-POCKET.",
		/obj/item/food/donkpocket/teriyaki = "[initial(name)] with NEW TERIYAKI-POCKET.",
