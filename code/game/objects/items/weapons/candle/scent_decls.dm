...
/decl/scent_type/rose
	color = COLOR_RED
	scent = "a rose garden"
	scent_datum = /datum/scent/candle/rose

/decl/scent_type/citrus
	color = COLOR_ORANGE
	scent = "assorted citrus"
	scent_datum = /datum/scent/candle/citrus

/decl/scent_type/sage
	color = COLOR_OFF_WHITE
	scent = "white sage"
	scent_datum = /datum/scent/candle/sage

/decl/scent_type/frankincense
	color = COLOR_AMBER
	scent = "frankincense"
	scent_datum = /datum/scent/candle/frankincense

/decl/scent_type/mint
	color = COLOR_PALE_BTL_GREEN
	scent = "crisp mint"
	scent_datum = /datum/scent/candle/mint

/decl/scent_type/champa
	color = COLOR_BLUE
	scent = "nag champa"
	scent_datum = /datum/scent/candle/champa

/decl/scent_type/lavender
	color = COLOR_PALE_PINK
	scent = "gentle lavender"
	scent_datum = /datum/scent/candle/lavender

/decl/scent_type/cinnamon
	color = COLOR_NT_RED
	scent = "spicy cinnamon"
	scent_datum = /datum/scent/candle/cinnamon

/decl/scent_type/vanilla
	color = WOOD_COLOR_PALE2
	scent = "gentle lavender"
	scent_datum = /datum/scent/candle/vanilla

/decl/scent_type/seabreeze
	color = COLOR_BLUE_GRAY
	scent = "a sea breeze"
	scent_datum = /datum/scent/candle/seabreeze

/decl/scent_type/sandalwood
	color = COLOR_YELLOW_GRAY
	scent = "sandalwood"
	scent_datum = /datum/scent/candle/sandalwood