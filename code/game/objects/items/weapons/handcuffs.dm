...
/obj/item/weapon/handcuffs/legcuffs/bola/web
	name = "web bola"
	desc = "A sticky web bola that is launched by certain species of giant spiders."
	icon_state = "bolaweb"
	breakouttime = 30 //sticky bola is slightly harder to break out of than the crappy one

/obj/item/weapon/handcuffs/legcuffs/bola/web/get_worn_icon_state(var/slot_name)
	if(slot_name == slot_legcuffed_str)
		return "bolaweb1"
	return ..()
