...
/obj/item/weapon/card/id/civilian/pilot
	initial_sprite_stack = list("base-stamp", "top-generic", "stamp-n", "stripe-black")
...
/obj/item/weapon/card/id/exploration/fm
	initial_sprite_stack = list("base-stamp", "top-dark", "stamp-n", "stripe-medblu")

/obj/item/weapon/card/id/exploration/head
	initial_sprite_stack = list("base-stamp-silver", "top-dark", "stamp-n", "pips-white")
