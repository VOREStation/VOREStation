...
/obj/item/weapon/card/id/exploration
	initial_sprite_stack = list("base-stamp", "top-gold", "stamp-n")

/obj/item/weapon/card/id/exploration/fm
	initial_sprite_stack = list("base-stamp", "top-gold", "stamp-n", "stripe-medblu")

/obj/item/weapon/card/id/exploration/head
	initial_sprite_stack = list("base-stamp-silver", "top-gold", "stamp-n", "pips-white")
