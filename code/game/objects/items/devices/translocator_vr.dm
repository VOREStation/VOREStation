...
/obj/item/perfect_tele_beacon/attack_self(mob/user)
	...
	if(confirm == "Eat it!")
		...
		if(bellychoice)
			user.visible_message(span_warning("[user] is trying to stuff \the [src] into [user.p_their()] [bellychoice.name]!"),span_notice("You begin putting \the [src] into your [bellychoice.name]!"))
