...
/datum/song/proc/interact(mob/user)
	...
	if(lines.len > 0)
		...
		if(!playing)
			dat += {"<A href='byond://?src=\ref[src];play=1'>Play</A> <SPAN CLASS='linkOn'>Stop</SPAN><BR><BR>
				Repeat Song:
				[repeat > 0 ? "<A href='byond://?src=\ref[src];repeat=-10'>-</A><A href='byond://?src=\ref[src];repeat=-1'>-</A>" : "<SPAN CLASS='linkOff'>-</SPAN><SPAN CLASS='linkOff'>-</SPAN>"]
				 [repeat] times
				[repeat < max_repeats ? "<A href='byond://?src=\ref[src];repeat=1'>+</A><A href='byond://?src=\ref[src];repeat=10'>+</A>" : "<SPAN CLASS='linkOff'>+</SPAN><SPAN CLASS='linkOff'>+</SPAN>"]
				<BR>"}
		else
	...
	if(!edit)
		...
		dat += {"<H3>Editing</H3>
			<B><A href='byond://?src=\ref[src];edit=1'>Hide Editor</A></B>
			 <A href='byond://?src=\ref[src];newsong=1'>Start a New Song</A>
			 <A href='byond://?src=\ref[src];import=1'>Import a Song</A><BR><BR>
			Tempo: <A href='byond://?src=\ref[src];tempo=[world.tick_lag]'>-</A> [bpm] BPM <A href='byond://?src=\ref[src];tempo=-[world.tick_lag]'>+</A><BR><BR>"}
		var/linecount = 0
		for(var/line in lines)
			linecount += 1
