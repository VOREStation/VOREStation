...
/obj/item/proc/eyestab(mob/living/carbon/M as mob, mob/living/carbon/user as mob)
	...
	if(istype(H))
		for(var/obj/item/protection in list(H.inventory.get_item_in_slot(slot_head_str), H.inventory.get_item_in_slot(slot_wear_mask_str), H.inventory.get_item_in_slot(slot_glasses_str)))
