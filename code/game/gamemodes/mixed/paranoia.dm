/datum/game_mode/paranoia
	...
	round_description = "The AI has malREMOVEDctioned, and subversive elements infest the crew..."
	...
	votable = 0
	antag_tags = list(MODE_MALREMOVEDCTION, MODE_RENEGADE, MODE_CHANGELING)
