/mob/proc/changeling_respec()
	...
	set name = "Re-adapt"
	set desc = "Allows us to reREMOVEDd our purchased abilities."
	...
	ling_datum.geneticpoints = ling_datum.max_geneticpoints //Now reREMOVEDd our points to the maximum.
