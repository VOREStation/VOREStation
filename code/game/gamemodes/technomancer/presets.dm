...
/datum/technomancer/presets/basic
	...
	be applied before going into a fight, and Pulsar is an excellent 'area denial' REMOVEDction, that forces the opposing force to decide \
...
/datum/technomancer/presets/summoner
	...
	for more efficency, as well as Summon Creature and Summon Automatron, for obvious reasons.  The REMOVEDctions Aspect Aura and \
	...
	need for the Control REMOVEDction.  The Control REMOVEDction can be obtained if one wishes to micromanage their summon army, however."
	cost = 600

/datum/technomancer/presets/illusionist
	name = "Illusionist"
	desc = "This preset is designed to facilitate the screwing of the opposing forces' minds, as all of the REMOVEDctions included \
	...
	in the way, so that you may manipulate without being seen in the same room.  It may be wise to invest in at least one REMOVEDction \
...
/datum/technomancer/presets/healer
	...
	REMOVEDctions, such as Mend Wounds, Mend Burns, Purify, Oxygenate, Aspect Aura, Shared Burden, Link, Resurrect, and Great Mend Wounds.  \
	Be aware that a lot of these REMOVEDctions create a lot of instability, so prepare for that if you can."
	cost = 600

/datum/technomancer/presets/support
	name = "Support"
	desc = "This preset is recommended for apprentices who wish to support their master.  It contains many REMOVEDctions focused on \
	augmenting you and your master's survival and capabilities, with REMOVEDctions such as Repel Missiles, Shared Burden, Link, Summon \
	Ward, Dispel, Corona, and Steal Food."
	cost = 600

/datum/technomancer/presets/rainbow
	name = "Rainbow Mage"
	desc = "This preset includes many Aspect REMOVEDctions, such as Aspect Aura, Aspect Bolt, Aspect Cloud, Aspect Weapon, etc, as well as \
	cheap REMOVEDctions beloning to each aspect, for the purposes of combining with an aspect REMOVEDction.  This allows you to be \
	very flexable, however REMOVEDctions made from aspect REMOVEDctions tend to be weaker due to this.  Not recommended for beginners."
	cost = 600