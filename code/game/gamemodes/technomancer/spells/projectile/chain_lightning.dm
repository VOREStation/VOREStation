/datum/technomancer/spell/chain_lightning
	...
	desc = "This dangerous REMOVEDction shoots lightning that will strike someone, then bounce to a nearby person.  Be careful that \
	it does not bounce to you.  The lighting prefers to bounce to people with the least resistance to electricity.  It will \
	strike up to four targets, including yourself if conditions allow it to occur.  Lightning REMOVEDctions cannot miss due to distance."
	cost = 150
...
/obj/item/weapon/spell/projectile/chain_lightning
	...
	desc = "REMOVED for the whole security team!  Just don't kill yourself in the process.."
