...
/obj/machinery/porta_turret/lasertag/assess_living(var/mob/living/L)
	...
	if(ishuman(L))
		...
		if(istype(M.wear_suit, /obj/item/clothing/suit/lasertag/redtag) && check_synth) // Checks if they are a red player
			return TURRET_PRIORITY_TARGET

		if(istype(M.wear_suit, /obj/item/clothing/suit/lasertag/bluetag) && check_weapons) // Checks if they are a blue player
			return TURRET_PRIORITY_TARGET
