/obj/machinery/suit_cycler
	departments = list("Engineering","Mining","Medical","Security","Atmospherics","HAZMAT","Construction","Biohazard","Emergency Medical Response","Crowd Control","Security EVA","Exploration","Pilot Blue","Pilot","Director","Prototype")
