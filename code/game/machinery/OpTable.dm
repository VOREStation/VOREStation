...
/obj/machinery/optable/proc/take_victim(mob/living/carbon/C, mob/living/carbon/user as mob)
	if(C == user)
		...
		visible_message("<span class='notice'>\The [C] has been laid on \the [src] by [user].</span>", "<span class='notice'>You have been laid on \the [src] by [user].</span>")	//VOREStation Edit
	if(C.client)
