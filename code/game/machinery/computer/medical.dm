				...
				if(4.0)
					...
					if ((istype(src.active1, /datum/data/record) && data_core.general.Find(src.active1)))
						...
						if ((istype(src.active2, /datum/data/record) && data_core.medical.Find(src.active2)))
							dat += "Gender identity: <A href='byond://?src=\ref[src];field=id_gender'>[active2.fields["id_gender"]]</A><BR>"
						else
							dat += "Gender identity: <A href='byond://?src=\ref[src];field=id_gender'>Unknown</A><BR>"
						dat +=  "Age: <A href='byond://?src=\ref[src];field=age'>[active1.fields["age"]]</A><BR>\n	\
