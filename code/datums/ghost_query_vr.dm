...
/datum/ghost_query/maints_spawner
	...
	question = "An opportunity to spawn as a Maintenance Critter has appeared. You can spawn as your choice of a mob, a morph, or your currently loaded character slot."
	cutoff_number = 1
