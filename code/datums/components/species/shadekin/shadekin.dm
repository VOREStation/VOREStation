...
/datum/component/shadekin/tgui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	...
	switch(action)
		if("adjust_time")
			...
			ui.user.write_preference_directly(/datum/preference/numeric/living/flicker_time, new_time, FALSE)
			return TRUE
		if("adjust_color")
			...
			ui.user.write_preference_directly(/datum/preference/color/living/flicker_color, set_new_color, FALSE)
			return TRUE
		if("adjust_break")
			...
			ui.user.write_preference_directly(/datum/preference/numeric/living/flicker_break_chance, new_break_chance, FALSE)
			return TRUE
		if("adjust_distance")
			...
			ui.user.write_preference_directly(/datum/preference/numeric/living/flicker_distance, new_distance, FALSE)
			return TRUE
		if("toggle_retreat")
			var/new_retreat = !no_retreat
			no_retreat = !no_retreat
			ui.user.write_preference_directly(/datum/preference/toggle/living/dark_retreat_toggle, new_retreat, FALSE)
		if("toggle_nutrition")
			var/new_retreat = !nutrition_energy_conversion
			nutrition_energy_conversion = !nutrition_energy_conversion
			ui.user.write_preference_directly(/datum/preference/toggle/living/shadekin_nutrition_conversion, new_retreat, FALSE)
