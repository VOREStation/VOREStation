...
/datum/component/slippery/Initialize(_weaken, _lube_flags = NONE, datum/callback/_callback, _stun, _force_drop = FALSE)
...
/datum/component/slippery/proc/Slip(datum/source, atom/movable/AM)
	var/mob/victim = AM
	if(istype(victim) && victim.slip(weaken_time, parent, lube_flags, stun_time, force_drop_items) && callback)
