...
/proc/html2pencode(t)
	...
	t = replacetext(t, "<img src = [SSassets.transport.get_asset_url("ntlogo.png")]>", "\[logo\]")
	t = replacetext(t, "<img src = [SSassets.transport.get_asset_url("redntlogo.png")]>", "\[redlogo\]")
	t = replacetext(t, "<img src = [SSassets.transport.get_asset_url("sglogo.png")]>", "\[sglogo\]")
