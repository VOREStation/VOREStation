...
/datum/controller/subsystem/air/Initialize()
	...
	//admin_notice({"<span class='danger'>Geometry initialized in [round(0.1*(REALTIMEOFDAY-timeofday),0.1)] seconds.</span> FIXME
	admin_notice({"<span class='danger'>Geometry initialized in UNKNOWN seconds.</span>
<span class='info'>
