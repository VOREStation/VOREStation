...
/datum/map_template/engine/rust
	...
	mappath = 'maps/submaps/engine_submaps_vr/junglebase/engine_rust.dmm'

/datum/map_template/engine/singulo
	name = "Singularity Engine"
	desc = "Lord Singuloth"
	mappath = 'maps/submaps/engine_submaps_vr/junglebase/engine_singulo.dmm'

/datum/map_template/engine/supermatter
	name = "Supermatter Engine"
	desc = "Old Faithful Supermatter"
	mappath = 'maps/submaps/engine_submaps_vr/junglebase/engine_sme.dmm'

/datum/map_template/engine/tesla
	name = "Edison's Bane"
	desc = "The Telsa Engine"
	mappath = 'maps/submaps/engine_submaps_vr/junglebase/engine_tesla.dmm'