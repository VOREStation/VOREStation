...
/obj/random/slimecore/item_to_spawn()
	return pick(/obj/item/slime_extract/metal,
				...
				prob(66);/obj/item/slime_extract/oil,
				prob(66);/obj/item/slime_extract/bluespace,
				prob(66);/obj/item/slime_extract/cerulean,
				prob(66);/obj/item/slime_extract/amber,
				prob(66);/obj/item/slime_extract/sapphire,
				prob(66);/obj/item/slime_extract/ruby,
				prob(66);/obj/item/slime_extract/emerald,
				prob(66);/obj/item/slime_extract/light_pink,
				prob(33);/obj/item/slime_extract/grey,
				prob(33);/obj/item/slime_extract/rainbow)
