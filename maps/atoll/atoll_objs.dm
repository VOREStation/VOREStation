...
/area/gateway/atoll
	...
	forced_ambience = list('maps/atoll/sounds/lakeamb.ogg')
...
/obj/structure/canopy
	...
	icon = 'maps/atoll/icons/objs/canopies.dmi'
	icon_state = "full"
	anchored = 1
	density = 1
	layer = MOB_LAYER + 0.2
...
/obj/structure/aqueduct
	...
	icon = 'maps/atoll/icons/objs/aqueducts.dmi'
	icon_state = "aqueduct"
	anchored = 1
	density = 0
	layer = MOB_LAYER + 0.4
...
/obj/structure/aqueduct/corner
	icon = 'maps/atoll/icons/objs/aqueducts_64.dmi'
...
/obj/structure/temple
	...
	desc = "A building that appears to have fallen under the water. This only appears to be the top of the structure; the rest of it can't be seen past the murk."
	icon = 'maps/atoll/icons/objs/temple.dmi'
	icon_state = "temple"
	anchored = 1
	density = 0
...
/obj/structure/waterfall
	name = "waterfall"
	desc = "How scenic!"
	icon = 'maps/atoll/icons/objs/waterfall.dmi'
	icon_state = "bottom"
	anchored = 1
	density = 0
...
/obj/structure/monolith
	...
	icon = 'maps/atoll/icons/objs/monolith.dmi'
	icon_state = "monolith"
	anchored = 1
	density = 1
	layer = MOB_LAYER + 0.4
...
/datum/looping_sound/monolith
	mid_sounds = 'maps/atoll/sounds/monolith.ogg'
	volume = 30
