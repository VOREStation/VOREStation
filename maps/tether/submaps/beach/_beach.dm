...
/obj/tether_away_spawner/beach_cave
	...
	guard = 20
	mobs_to_pick_from = list(
		/mob/living/simple_mob/vore/aggresive/frog = 3, //Frogs are 3x more likely to spawn than,
		/mob/living/simple_mob/vore/aggresive/deathclaw = 1, //these deathclaws are, with these values,
		/mob/living/simple_mob/animal/giant_spider = 3,
		/mob/living/simple_mob/vore/aggresive/giant_snake = 1,
