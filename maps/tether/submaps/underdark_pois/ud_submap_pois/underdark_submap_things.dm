...
// Underdark Submap mob spawners
/obj/tether_away_spawner/underdark_submap/normal_mob
	name = "Underdark Submap Normal Spawner"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	prob_fall = 50
	...
	mobs_to_pick_from = list(
		/mob/living/simple_mob/animal/giant_spider/electric = 2,
		/mob/living/simple_mob/animal/giant_spider/frost = 2,
		/mob/living/simple_mob/animal/giant_spider/hunter = 2,
		/mob/living/simple_mob/animal/giant_spider/phorogenic/weak = 2,
		/mob/living/simple_mob/animal/giant_spider/tunneler = 3,
	)

/obj/tether_away_spawner/underdark_submap/hard_mob
	name = "Underdark Submap Hard Spawner"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	prob_fall = 50
	//guard = 20
	mobs_to_pick_from = list(
		/mob/living/simple_mob/vore/aggressive/corrupthound = 2,
...
/obj/tether_away_spawner/underdark_submap/regular_spider_randomizer
	name = "Underdark Submap Spider Randomizer"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	prob_fall = 15
	...
	mobs_to_pick_from = list(
		...
		/mob/living/simple_mob/animal/giant_spider/frost = 2,
		/mob/living/simple_mob/animal/giant_spider/lurker = 2,
		/mob/living/simple_mob/animal/giant_spider/phorogenic = 3,
	)

/obj/tether_away_spawner/underdark_submap/support_spider_randomizer
	name = "Underdark Submap Spider Randomizer"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	...
	//guard = 70
	mobs_to_pick_from = list(
		/mob/living/simple_mob/animal/giant_spider/carrier = 4,
...
/obj/tether_away_spawner/underdark_submap/deadly_spider_randomizer
	name = "Underdark Submap Spider Randomizer"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	...
	//guard = 70
	mobs_to_pick_from = list(
		/mob/living/simple_mob/animal/giant_spider/nurse/queen = 1,
		/mob/living/simple_mob/animal/giant_spider/carrier = 2,
		/mob/living/simple_mob/animal/giant_spider/lurker = 4,
		/mob/living/simple_mob/animal/giant_spider/thermic = 3,
	)

/obj/tether_away_spawner/underdark_submap/murder_mob
	name = "Underdark Submap Boss Spawner"
	faction = "underdark"
	atmos_comp = TRUE
	prob_spawn = 100
	prob_fall = 100
	...
	mobs_to_pick_from = list(
		...
		/mob/living/simple_mob/vore/aggressive/dino = 4,
		/mob/living/simple_mob/vore/aggressive/corrupthound = 8,
	)
