...
/obj/item/gun/projectile/silenced/sc_silenced/Initialize()
	. = ..()
...
/obj/item/gun/projectile/automatic/c20r/sc_c20r/Initialize()
	. = ..()
	for(var/ammo in loaded)
		if(prob(95)) //95% chance
			loaded -= ammo
...
/obj/item/gun/projectile/shotgun/pump/sc_pump/Initialize()
	. = ..()
	for(var/ammo in loaded)
		if(prob(95)) //95% chance
			loaded -= ammo
...
/obj/item/paper/sc_safehint_paper_prison/Initialize()
	. = ..()
...
/obj/item/paper/sc_safehint_paper_hydro
	name = "shredded paper"
/obj/item/paper/sc_safehint_paper_hydro/Initialize()
	. = ..()
...
/obj/item/paper/sc_safehint_paper_bible
	name = "hidden paper"
/obj/item/paper/sc_safehint_paper_bible/Initialize()
	. = ..()
