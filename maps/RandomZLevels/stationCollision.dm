...
/obj/item/paper/sc_safehint_paper_prison/New()
	info = span_italics("The ink is smudged, you can only make out a couple numbers:") + " '[GLOB.sc_safecode1]**[GLOB.sc_safecode4]*'"

/obj/item/paper/sc_safehint_paper_hydro
	name = "shredded paper"
/obj/item/paper/sc_safehint_paper_hydro/New()
	info = span_italics("Although the paper is shredded, you can clearly see the number:") + " '[GLOB.sc_safecode2]'"
