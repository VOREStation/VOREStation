...
//////////////////////////////////////////////////////////////////////////////
/// Static Load
/datum/map_template/junglebase_lateload/misc
	name = "Misc"
	desc = "Misc areas, like some transit areas, holodecks, merc area."
	mappath = 'misc.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/misc

/datum/map_z_level/junglebase_lateload/misc
	name = "Misc"
	flags = MAP_LEVEL_ADMIN|MAP_LEVEL_SEALED|MAP_LEVEL_CONTACT|MAP_LEVEL_XENOARCH_EXEMPT

#include "underdark_pois/_templates.dm"
#include "underdark_pois/underdark_things.dm"
/datum/map_template/junglebase_lateload/torris_underdark
	name = "Torris - Underdark"
	desc = "Mining, but harder."
	mappath = 'underdark.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/underdark

/datum/map_z_level/junglebase_lateload/underdark
	name = "Underdark"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	base_turf = /turf/simulated/mineral/floor/torris
	z = Z_LEVEL_UNDERDARK

/datum/map_template/junglebase_lateload/torris_underdark/on_map_loaded(z)
	. = ..()
...
#include "wilderness/_wilderness_templates.dm"
#include "wilderness/_wilderness_things.dm" // Currently empty, add things to it if you need to.
/datum/map_template/junglebase_lateload/wilderness
	name = "Wilderness"
	desc = "The wilds of Torris."
	mappath = 'wilderness.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/wilderness

/datum/map_z_level/junglebase_lateload/wilderness
	name = "Away Mission - Wilderness"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	base_turf = /turf/simulated/mineral/floor/torris
	z = Z_LEVEL_WILDERNESS

/datum/map_template/junglebase_lateload/wilderness/on_map_loaded(z)
	. = ..()
	seed_submaps(list(Z_LEVEL_WILDERNESS), 120, /area/junglebase/outpost/wilderness, /datum/map_template/surface/wilderness)
...
/datum/map_template/junglebase_lateload/roguemines1
	name = "Asteroid Belt 1"
	desc = "Mining, but rogue. Zone 1"
	mappath = 'maps/submaps/rogue_mines_vr/rogue_mine1.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/roguemines1

/datum/map_z_level/junglebase_lateload/roguemines1
	name = "Belt 1"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	z = Z_LEVEL_ROGUEMINE_1

/datum/map_template/junglebase_lateload/roguemines2
	name = "Asteroid Belt 2"
	desc = "Mining, but rogue. Zone 2"
	mappath = 'maps/submaps/rogue_mines_vr/rogue_mine2.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/roguemines2

/datum/map_z_level/junglebase_lateload/roguemines2
	name = "Belt 2"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	z = Z_LEVEL_ROGUEMINE_2

/datum/map_template/junglebase_lateload/roguemines3
	name = "Asteroid Belt 3"
	desc = "Mining, but rogue. Zone 3"
	mappath = 'maps/submaps/rogue_mines_vr/rogue_mine3.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/roguemines3

/datum/map_z_level/junglebase_lateload/roguemines3
	name = "Belt 3"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
	z = Z_LEVEL_ROGUEMINE_3

/datum/map_template/junglebase_lateload/roguemines4
	name = "Asteroid Belt 4"
	desc = "Mining, but rogue. Zone 4"
	mappath = 'maps/submaps/rogue_mines_vr/rogue_mine4.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/roguemines4

/datum/map_z_level/junglebase_lateload/roguemines4
	name = "Belt 4"
	flags = MAP_LEVEL_CONTACT|MAP_LEVEL_PLAYER
...
/datum/map_template/junglebase_lateload/away_beach
	name = "Desert Planet - Z1 Beach"
	desc = "The beach away mission."
	mappath = 'maps/expedition_vr/beach/beach.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_beach

/datum/map_z_level/junglebase_lateload/away_beach
	name = "Away Mission - Desert Beach"
	z = Z_LEVEL_BEACH
	base_turf = /turf/simulated/floor/outdoors/rocks/caves

/datum/map_template/junglebase_lateload/away_beach_cave
	name = "Desert Planet - Z2 Cave"
	desc = "The beach away mission's cave."
	mappath = 'maps/expedition_vr/beach/cave.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_beach_cave

/datum/map_template/junglebase_lateload/away_beach_cave/on_map_loaded(z)
	. = ..()
...
/datum/map_z_level/junglebase_lateload/away_beach_cave
...
/datum/map_template/junglebase_lateload/away_alienship
	name = "Alien Ship - Z1 Ship"
	desc = "The alien ship away mission."
	mappath = 'maps/expedition_vr/alienship/alienship.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_alienship

/datum/map_z_level/junglebase_lateload/away_alienship
	name = "Away Mission - Alien Ship"


#include "../../expedition_vr/aerostat/_aerostat.dm"
/datum/map_template/junglebase_lateload/away_aerostat
	name = "Remmi Aerostat - Z1 Aerostat"
	desc = "The Virgo 2 Aerostat away mission."
	mappath = 'maps/expedition_vr/aerostat/aerostat.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_aerostat

/datum/map_z_level/junglebase_lateload/away_aerostat
	name = "Away Mission - Aerostat"
	z = Z_LEVEL_AEROSTAT
	base_turf = /turf/unsimulated/floor/sky/virgo2_sky

/datum/map_template/junglebase_lateload/away_aerostat_surface
	name = "Remmi Aerostat - Z2 Surface"
	desc = "The surface from the Virgo 2 Aerostat."
	mappath = 'maps/expedition_vr/aerostat/surface.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_aerostat_surface

/datum/map_template/junglebase_lateload/away_aerostat_surface/on_map_loaded(z)
	. = ..()
...
/datum/map_z_level/junglebase_lateload/away_aerostat_surface
...
/datum/map_template/junglebase_lateload/away_debrisfield
	...
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_debrisfield
...
/datum/map_template/junglebase_lateload/away_fueldepot
	name = "Fuel Depot - Z1 Space"
	desc = "An unmanned fuel depot floating in space."
	mappath = 'maps/expedition_vr/space/fueldepot.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/away_fueldepot
...
/datum/map_template/junglebase_lateload/gateway
	name = "Gateway Submap"
	desc = "Please do not use this."
	mappath = null
	associated_map_datum = null

/datum/map_z_level/junglebase_lateload/gateway_destination
	name = "Gateway Destination"
	z = Z_LEVEL_GATEWAY

#include "../../gateway_vr/snow_outpost.dm"
/datum/map_template/junglebase_lateload/gateway/snow_outpost
	name = "Snow Outpost"
	desc = "Big snowy area with various outposts."
	mappath = 'maps/gateway_vr/snow_outpost.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/gateway_destination

#include "../../gateway_vr/zoo.dm"
/datum/map_template/junglebase_lateload/gateway/zoo
	name = "Zoo"
...
/datum/map_template/junglebase_lateload/gateway/carpfarm
	name = "Carp Farm"
...
/datum/map_template/junglebase_lateload/gateway/snowfield
	name = "Snow Field"
...
/datum/map_template/junglebase_lateload/gateway/listeningpost
	name = "Listening Post"
...
/datum/map_template/junglebase_lateload/fun/spa
	name = "Space Spa"
	desc = "A pleasant spa located in a spaceship."
	mappath = 'maps/submaps/admin_use_vr/spa.dmm'

	associated_map_datum = /datum/map_z_level/junglebase_lateload/fun/spa

/datum/map_z_level/junglebase_lateload/fun/spa
	name = "Spa"
	flags = MAP_LEVEL_PLAYER|MAP_LEVEL_SEALED

//////////////////////////////////////////////////////////////////////////////////////
// Code Shenanigans for Tether lateload maps
/datum/map_template/junglebase_lateload
	allow_duplicates = FALSE
	var/associated_map_datum

/datum/map_template/junglebase_lateload/on_map_loaded(z)
...
/datum/map_z_level/junglebase_lateload
	z = 0
	flags = MAP_LEVEL_SEALED

/datum/map_z_level/junglebase_lateload/New(var/datum/map/map, mapZ)
	if(mapZ && !z)
		z = mapZ
	return ..(map)
...
// Talon offmap spawn
/datum/map_template/junglebase_lateload/offmap/talon1
	name = "Offmap Ship - Talon Z1"
	desc = "Offmap spawn ship, the Talon."
	mappath = 'maps/offmap_vr/talon/talon1.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/talon1

/datum/map_template/junglebase_lateload/offmap/talon2
	name = "Offmap Ship - Talon Z2"
	desc = "Offmap spawn ship, the Talon."
	mappath = 'maps/offmap_vr/talon/talon2.dmm'
	associated_map_datum = /datum/map_z_level/junglebase_lateload/talon2

/datum/map_z_level/junglebase_lateload/talon1
	name = "Talon Deck One"
	flags = MAP_LEVEL_PLAYER
	base_turf = /turf/space
	z = Z_LEVEL_OFFMAP1

/datum/map_z_level/junglebase_lateload/talon2
	name = "Talon Deck Two"
	flags = MAP_LEVEL_PLAYER
