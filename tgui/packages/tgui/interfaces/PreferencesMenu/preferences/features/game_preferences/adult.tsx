...
export const VORE_FOODSYNTH_COOKIES: FeatureToggle = {
	name: "Foodsynth Cookies",
	category: "ADULT CONTENT",
	description:
		"Opt-in to allow crewmembers to print minature replica cookies from food synthesizers of yourself.",
	component: CheckboxInput,
};
