  ...
  render() {
    ...
    const header = (
      <Section>
        ...
        <p>
          <b>Thanks to: </b>
          Polaris Station, Baystation 12, /tg/ station, /vg/station, GoonStation devs, the original SpaceStation
          developers and Mockingjay00 for the title image. Also a thanks to anybody who has contributed who is not
          listed here.
        </p>
        <p>
          ...
          <a href="https://github.com/VOREStation/VOREStation/pulse/monthly">here</a>.
        </p>
        <p>
          {'Visit our wiki '}
    ...
    const footer = (
      <Section>
        ...
        <p>
          <b>Coders: </b>
          Stuntwaffle, Showtime, Pantaloons, Nannek, Keelin, Exadv1, hobnob, Justicefries, 0staf, sniperchance,
        ...
        <p>
          VOREStation is thankful to the GoonStation 13 Development Team for its work on the game up to the
        ...
        <p>
          {'All code after '}
          <a href={'https://github.com/VOREStation/VOREStation/commit/' + '333c566b88108de218d882840e61928a9b759d8f'}>
          ...
          <a href="https://github.com/VOREStation/VOREStation/blob/master/LICENSE">LICENSE</a>
          {' and '}
          <a href="https://github.com/VOREStation/VOREStation/blob/master/LICENSE-GPL3.txt">GPLv3.txt</a>
          {' for more details.'}
        </p>
        <p>
          The TGS DMAPI API is licensed as a subproject under the MIT license.
          {' See the footer of '}
          <a href={'https://github.com/VOREStation/VOREStation/blob/master' + '/code/__DEFINES/tgs.dm'}>
            code/__DEFINES/tgs.dm
          </a>
          {' and '}
          <a href={'https://github.com/VOREStation/VOREStation/blob/master' + '/code/modules/tgs/LICENSE'}>
