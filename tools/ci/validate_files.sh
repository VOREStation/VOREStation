...
booleans="sharp edge density anchored can_buckle use_to_pickup was_bloodied canremove simulated panel_open opacity emagged unacidable climbable attack_sharp"
